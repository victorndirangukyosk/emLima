...
class ControllerDashboardAccountManagerCustomersOnline extends Controller
{
    public function index()
    {
        ...
        // Customers Online
        $online_total = $this->model_report_customer->getTotalAccountManagerCustomersOnline();
