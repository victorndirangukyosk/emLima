...
class ControllerDashboardAccountManagerCharts extends Controller
{
    ...
    public function accountmanagersales()
    {
        $this->load->language('dashboard/charts');
    ...
    public function accountmanagerbookedsales()
    {
        $this->load->language('dashboard/charts');
        $this->load->model('dashboard/charts');
    ...
    public function AccountManagerOrders()
    {
        $this->load->language('dashboard/charts');
    ...
    public function AccountManagerCreatedOrders()
    {
        $this->load->language('dashboard/charts');
    ...
    public function AccountManagerCancelledOrders()
    {
        $this->load->language('dashboard/charts');
