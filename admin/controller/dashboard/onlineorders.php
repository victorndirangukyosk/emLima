...
class ControllerDashboardOnlineOrders extends Controller {
    ...
    public function OnlineOrdersAll() {
        // $this->load->language('dashboard/online');
        ...
        $data['online_orders_url'] = htmlspecialchars_decode($this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&filter_order_type=0&filter_date_added=2021-01-01&filter_date_added_end=' . $enddate , 'SSL'));
    ...
    public function onlineOrdersByRange() {
        ...
        $data['online_orders_url'] = htmlspecialchars_decode($this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&filter_order_type=0&filter_date_added='. $this->request->get['filter_date_added'].'&filter_date_added_end=' . $this->request->get['filter_date_added_end'], 'SSL'));
