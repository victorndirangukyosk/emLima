...
class ControllerDashboardManualOrders extends Controller {
    ...
    public function ManualOrdersByRange() {
        ...
        $data['manual_orders_url'] = htmlspecialchars_decode($this->url->link('sale/order', 'token=' . $this->session->data['token'] . '&filter_order_type=1&filter_date_added='. $this->request->get['filter_date_added'].'&filter_date_added_end=' . $this->request->get['filter_date_added_end'], 'SSL'));
