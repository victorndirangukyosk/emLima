...
class ControllerCatalogOption extends Controller
{
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->get['option_id']) && ('POST' != $this->request->server['REQUEST_METHOD'])) {
    ...
    protected function validateForm()
    {
        ...
        if (('select' == $this->request->post['type'] || 'radio' == $this->request->post['type'] || 'checkbox' == $this->request->post['type']) && !isset($this->request->post['option_value'])) {
    ...
    public function autocomplete()
    {
        ...
        if (isset($this->request->get['filter_name'])) {
            ...
            foreach ($options as $option) {
                ...
                if ('text' == $option['type'] || 'textarea' == $option['type']) {
                ...
                if ('date' == $option['type'] || 'datetime' == $option['type'] || 'time' == $option['type']) {
