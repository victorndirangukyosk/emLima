...
class ControllerCatalogAttribute extends Controller
{
    ...
    protected function getList()
    {
        ...
        if (!empty($filter_name) || !empty($filter_group)) {
            $attribute_total = $this->model_catalog_attribute->getTotalAttributesFilter($filter_data);
        } else {
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->get['attribute_id']) && ('POST' != $this->request->server['REQUEST_METHOD'])) {
