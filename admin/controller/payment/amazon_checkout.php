    ...
    public function index()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validate()) {
            ...
            if (!isset($this->request->post['amazon_checkout_allowed_ips'])) {
                $this->request->post['amazon_checkout_allowed_ips'] = [];
            }
        ...
        $data['cron_job_url'] = HTTPS_CATALOG.'index.php?path=payment/amazon_checkout/cron&token='.$data['amazon_checkout_cron_job_token'];
        ...
        if (isset($this->request->post['amazon_checkout_allowed_ips'])) {
            ...
            $data['amazon_checkout_ip_allowed'] = [];
        }
