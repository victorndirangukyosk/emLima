...
class ControllerPaymentStripe extends Controller
{
    ...
    public function index()
    {
        ...
        if (isset($this->request->post['stripe_connect_platform_id'])) {
            $data['stripe_connect_platform_id'] = $this->request->post['stripe_connect_platform_id'];
        } elseif ($this->config->has('stripe_connect_platform_id')) {
            $data['stripe_connect_platform_id'] = $this->config->get('stripe_connect_platform_id');
        } else {
            $data['stripe_connect_platform_id'] = '';
        }
