...
class ControllerPaymentRealex extends Controller
{
    ...
    public function index()
    {
        ...
        $data['notify_url'] = HTTPS_CATALOG.'index.php?path=payment/realex/notify';
    ...
    public function void()
    {
        ...
        if (isset($this->request->post['order_id']) && '' != $this->request->post['order_id']) {
            ...
            if (isset($void_response->result) && '00' == $void_response->result) {
    ...
    public function capture()
    {
        ...
        if (isset($this->request->post['order_id']) && '' != $this->request->post['order_id'] && isset($this->request->post['amount']) && $this->request->post['amount'] > 0) {
            ...
            if (isset($capture_response->result) && '00' == $capture_response->result) {
                ...
                if ($total_captured >= $realex_order['total'] || 0 == $realex_order['settle_type']) {
    ...
    public function rebate()
    {
        ...
        if (isset($this->request->post['order_id']) && !empty($this->request->post['order_id'])) {
            ...
            if (isset($rebate_response->result) && '00' == $rebate_response->result) {
                ...
                if ($total_captured <= 0 && 1 == $realex_order['capture_status']) {
