...
class ControllerPaymentFirstdataRemote extends Controller
{
    ...
    public function void()
    {
        ...
        if (isset($this->request->post['order_id']) && '' != $this->request->post['order_id']) {
            ...
            if ('APPROVED' == strtoupper($void_response['transaction_result'])) {
    ...
    public function capture()
    {
        ...
        if (isset($this->request->post['order_id']) && '' != $this->request->post['order_id']) {
            ...
            if ('APPROVED' == strtoupper($capture_response['transaction_result'])) {
    ...
    public function refund()
    {
        ...
        if (isset($this->request->post['order_id']) && '' != $this->request->post['order_id']) {
            ...
            if ('APPROVED' == strtoupper($refund_response['transaction_result'])) {
                ...
                if ($total_captured <= 0 && 1 == $firstdata_order['capture_status']) {
