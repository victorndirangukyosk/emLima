...
class ControllerPaymentSagepayDirect extends Controller
{
    ...
    public function index()
    {
        ...
        $data['sagepay_direct_cron_job_url'] = HTTPS_CATALOG.'index.php?path=payment/sagepay_direct/cron&token='.$data['sagepay_direct_cron_job_token'];
    ...
    public function release()
    {
        ...
        if (isset($this->request->post['order_id']) && '' != $this->request->post['order_id'] && isset($this->request->post['amount']) && $this->request->post['amount'] > 0) {
            ...
            if ('OK' == $release_response['Status']) {
                ...
                if ($total_released >= $sagepay_direct_order['total'] || 0 == $sagepay_direct_order['settle_type']) {
    ...
    public function rebate()
    {
        ...
        if (isset($this->request->post['order_id']) && !empty($this->request->post['order_id'])) {
            ...
            if ('OK' == $rebate_response['Status']) {
                ...
                if ($total_released <= 0 && 1 == $sagepay_direct_order['release_status']) {
