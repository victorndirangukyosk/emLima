...
class ControllerPaymentPPPayflowIframe extends Controller
{
    ...
    public function index()
    {
        ...
        $data['cancel_url'] = HTTPS_CATALOG.'index.php?path=payment/pp_payflow_iframe/paymentcancel';
        $data['error_url'] = HTTPS_CATALOG.'index.php?path=payment/pp_payflow_iframe/paymenterror';
        $data['return_url'] = HTTPS_CATALOG.'index.php?path=payment/pp_payflow_iframe/paymentreturn';
        $data['post_url'] = HTTPS_CATALOG.'index.php?path=payment/pp_payflow_iframe/paymentipn';
