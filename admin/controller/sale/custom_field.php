...
class ControllerSaleCustomField extends Controller
{
    ...
    public function add()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            $custom_field_id = $this->model_sale_custom_field->addCustomField($this->request->post);
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->get['custom_field_id']) && ('POST' != $this->request->server['REQUEST_METHOD'])) {
    ...
    protected function validateForm()
    {
        ...
        if (('select' == $this->request->post['type'] || 'radio' == $this->request->post['type'] || 'checkbox' == $this->request->post['type'])) {
            if (!isset($this->request->post['custom_field_value'])) {
