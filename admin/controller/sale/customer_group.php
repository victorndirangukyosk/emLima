...
class ControllerSaleCustomerGroup extends Controller
{
    ...
    public function add()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            ...
            if (isset($this->request->post['button']) and 'save' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('sale/customer_group/edit', 'customer_group_id='.$customer_group_id.'&token='.$this->session->data['token'].$url, 'SSL'));
            }

            if (isset($this->request->post['button']) and 'new' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('sale/customer_group/add', 'token='.$this->session->data['token'].$url, 'SSL'));
            }
    ...
    public function edit()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            ...
            if (isset($this->request->post['button']) and 'save' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('sale/customer_group/edit', 'customer_group_id='.$this->request->get['customer_group_id'].'&token='.$this->session->data['token'].$url, 'SSL'));
            }
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->get['customer_group_id']) && ('POST' != $this->request->server['REQUEST_METHOD'])) {
