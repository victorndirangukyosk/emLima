...
class ControllerSaleOrderProductAcceptRejectProducts extends Controller {

    private $error = [];

    public function index() {

        $this->load->language('sale/order_product_accept_reject');
        $this->document->setTitle($this->language->get('heading_title'));
        $this->load->model('sale/order');
        $this->getAcceptRejectProductsList();
    }

    
    protected function getAcceptRejectProductsList() {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . $url, 'SSL'),
        ];
        ...
        $filter_order_id_temp = $this->model_sale_order->getOrderedAcceptRejectProductsOnlyOrder($filter_data);
        ...
        if (!empty($filter_order_id_temp) ) {
            ...
            //   echo "<pre>";print_r($tmp);die;
                ...
                $filter_data['filter_order_id'] = $tmp;
                 ...
                 $order_total = $this->model_sale_order->getTotalOrderedAcceptRejectProducts($filter_data);

                  $results = $this->model_sale_order->getOrderedAcceptRejectProducts($filter_data);
        ...
        $data['sort_order'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
        $data['sort_city'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=c.name' . $url, 'SSL');
        $data['sort_customer'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
        $data['sort_status'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
        $data['sort_total'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
        $data['sort_date_added'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
        $data['sort_date_modified'] = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . '&sort=o.date_modified' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('sale/order_product_accept_reject_products', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('sale/order_product_accept_reject_products_list.tpl', $data));
    }
