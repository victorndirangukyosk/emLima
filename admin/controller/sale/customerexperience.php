...
class ControllerSaleCustomerExperience extends Controller {

    private $error = [];

    public function index() {
        $this->load->language('sale/customerexperience');
    ...
    public function export_excel() {
        ...
        $this->model_report_excel->download_customer_experience_excel($data);
    }
    ...
    public function add() {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            $user_id = $this->model_user_customerexperience->addCustomerExperience($this->request->post);
            ...
            $activity_data = [
                ...
                'customer_experience_id' => $user_id,
            ];
            $log->write('account manager add');

            $this->model_user_user_activity->addActivity('customer_experience_add', $activity_data);

            $log->write('customer experience add');
            ...
            if (isset($this->request->post['button']) and 'save' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('sale/customerexperience/edit', 'user_id=' . $user_id . '&token=' . $this->session->data['token'] . $url, 'SSL'));
            }

            if (isset($this->request->post['button']) and 'new' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('sale/customerexperience/add', 'token=' . $this->session->data['token'] . $url, 'SSL'));
            }

            $this->response->redirect($this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . $url, 'SSL'));
        }
    ...
    public function edit() {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            $this->model_user_customerexperience->editUser($this->request->get['user_id'], $this->request->post);
            ...
            $activity_data = [
                ...
                'name' => $this->user->getFirstName() . ' ' . $this->user->getLastName(),
                'user_group_id' => $this->user->getGroupId(),
                'customer_experience_id' => $this->request->get['user_id'],
            ];
            $log->write('customer experience edit');

            $this->model_user_user_activity->addActivity('customer_experience_edit', $activity_data);
            ...
            if (isset($this->request->post['button']) and 'save' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('sale/customerexperience/edit', 'user_id=' . $this->request->get['user_id'] . '&token=' . $this->session->data['token'] . $url, 'SSL'));
            }
    ...
    public function delete() {
        ...
        if (isset($this->request->post['selected']) && $this->validateDelete()) {
            foreach ($this->request->post['selected'] as $user_id) {
                $this->model_user_customerexperience->deleteUser($user_id);
                ...
                $log->write('customer experience delete');

                $this->model_user_user_activity->addActivity('customer_experience_delete', $activity_data);
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . $url, 'SSL'),
        ];

        $data['add'] = $this->url->link('sale/customerexperience/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
        $data['delete'] = $this->url->link('sale/customerexperience/delete', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $this->load->model('user/customerexperience');
        $customer_total = $this->model_user_customerexperience->getTotalCustomerExperience($filter_data);

        $results = $this->model_user_customerexperience->getCustomerExperience($filter_data);
        ...
        foreach ($results as $result) {
            ...
            $data['customers'][] = [
                ...
                'edit' => $this->url->link('sale/customerexperience/edit', 'token=' . $this->session->data['token'] . '&user_id=' . $result['user_id'] . $url, 'SSL'),
            ];
        }
        ...
        $data['sort_name'] = $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
        $data['sort_email'] = $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . '&sort=c.email' . $url, 'SSL');
        $data['sort_status'] = $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . '&sort=c.status' . $url, 'SSL');
        $data['sort_ip'] = $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . '&sort=c.ip' . $url, 'SSL');
        $data['sort_date_added'] = $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . '&sort=c.date_added' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('sale/customerexperience', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
    ...
    protected function getForm() {
        ...
        $this->response->setOutput($this->load->view('sale/customerexperience_form.tpl', $data));
    }
