...
class ControllerLocalisationReturnAction extends Controller
{
    ...
    public function add()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            $return_action_id = $this->model_localisation_return_action->addReturnAction($this->request->post);
            ...
            if (isset($this->request->post['button']) and 'save' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('localisation/return_action/edit', 'return_action_id='.$return_action_id.'&token='.$this->session->data['token'].$url, 'SSL'));
            }

            if (isset($this->request->post['button']) and 'new' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('localisation/return_action/add', 'token='.$this->session->data['token'].$url, 'SSL'));
            }
    ...
    public function edit()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            ...
            if (isset($this->request->post['button']) and 'save' == $this->request->post['button']) {
                $this->response->redirect($this->url->link('localisation/return_action/edit', 'return_action_id='.$this->request->get['return_action_id'].'&token='.$this->session->data['token'].$url, 'SSL'));
            }
