...
class ControllerReportAccountManagerCustomerOnline extends Controller
{
    public function index()
    {
        ...
        $customer_total = $this->model_report_customer->getTotalAccountManagerCustomersOnline($filter_data);

        $results = $this->model_report_customer->getAccountManagerCustomersOnline($filter_data);
        ...
        $this->response->setOutput($this->load->view('report/account_manager_customer_online.tpl', $data));
    }
}
