...
class ControllerReportSaleDaily extends Controller
{
    private $error = [];

    public function excel()
    {
        $this->load->language('report/sale_daily');
        ...
        $this->model_report_excel->download_sale_daily_excel($filter_data);
    }
    ...
    protected function getList()
    {
        ...
        $pagination->url = $this->url->link('report/sale_daily', 'token='.$this->session->data['token'].$url.'&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('report/sale_daily.tpl', $data));
    }
    ...
    public function city_autocomplete()
    {
        ...
        $json = $this->model_report_sale_daily->getCities();
