...
class ControllerReportAccountManagerCustomerOrder extends Controller
{
    public function index()
    {
        ...
        $customer_total = $this->model_report_customer->getAccountManagerTotalOrders($filter_data);

        $results = $this->model_report_customer->getAccountManagerOrders($filter_data);
        ...
        $this->response->setOutput($this->load->view('report/account_manager_customer_order.tpl', $data));
    }
