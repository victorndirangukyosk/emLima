...
class ControllerReportAccountManagerCustomerActivity extends Controller
{
    public function index()
    {
        ...
        $data['breadcrumbs'][] = [
            'href' => $this->url->link('report/account_manager_customer_activity', 'token='.$this->session->data['token'].$url, 'SSL'),
        ...
        $pagination->url = $this->url->link('report/account_manager_customer_activity', 'token='.$this->session->data['token'].$url.'&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('report/account_manager_customer_activity.tpl', $data));
    }
}
