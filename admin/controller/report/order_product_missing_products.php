...
class ControllerReportOrderProductMissingProducts extends Controller {
    ...
    protected function getMissingProductsList() {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . $url, 'SSL'),
        ];
        ...
        $data['sort_order'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
        $data['sort_city'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=c.name' . $url, 'SSL');
        $data['sort_customer'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
        $data['sort_status'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
        $data['sort_total'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
        $data['sort_date_added'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
        $data['sort_date_modified'] = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . '&sort=o.date_modified' . $url, 'SSL');
        ...
        $pagination->url = $this->url->link('report/order_product_missing_products', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('report/order_product_missing_products_list.tpl', $data));
    }
