...
class ControllerReportCommission extends Controller
{
    public function excel()
    {
        ...
        $this->model_report_excel->download_vendor_commission($data);
    }
    ...
    public function index()
    {
        ...
        $order_total = $this->model_report_sale->getTotalOrdersCommission($filter_data);
        ...
        $this->response->setOutput($this->load->view('report/commission.tpl', $data));
    }
    ...
    public function autocomplete()
    {
        ...
        $json = $this->model_sale_order->getVendorUserDataOnlyFirstName($filter_name);
