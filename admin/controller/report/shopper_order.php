    ...
    public function getChartData($currency_format = false) {
        ...
        switch ($range) {
            case 'hour':
                ...
                $order_fullfilled = array();

                for ($i = 0; $i < 24; $i++) {
                    $order_assigned[$i] = array(
                        'hour' => $i,
                        'total' => 0
                    );
                    
                    $order_rejected[$i] = array(
                        'hour' => $i,
                        'total' => 0
                    );
                    
                    $order_fullfilled[$i] = array(
                        'hour' => $i,
                        'total' => 0
                    );
                ...
                foreach ($assigned as $result) {
                    $order_assigned[$result['hour']] = array(
                        'hour' => $result['hour'],
                        'total' => $result['total']
                    );
                }
                ...
                foreach ($rejected as $result) {
                    $order_rejected[$result['hour']] = array(
                        'hour' => $result['hour'],
                        'total' => $result['total']
                    );
                }
                foreach ($fullfilled as $result) {
                    $order_fullfilled[$result['hour']] = array(
                        'hour' => $result['hour'],
                        'total' => $result['total']
                    );
                }
                ...
                foreach ($order_assigned as $key => $value) {
                    $json['order']['assigned'][] = array($key, $value['total']);
                }

                foreach ($order_rejected as $key => $value) {
                    $json['order']['rejected'][] = array($key, $value['total']);
                }

                foreach ($order_fullfilled as $key => $value) {
                    $json['order']['fullfiled'][] = array($key, $value['total']);
                }
            ...
            case 'day':
                ...
                for ($i = 0; $i < $diff; $i++) {
                    ...
                    $order_assigned[$date] = array(
                        'day' => $date,
                        'total' => 0
                    );

                    $order_rejected[$date] = array(
                        'day' => $date,
                        'total' => 0
                    );
                    
                    $order_fullfilled[$date] = array(
                        'day' => $date,
                        'total' => 0
                    );
                ...
                foreach ($assigned as $result) {
                    ...
                    $order_assigned[$result['date']] = array(
                        'day' => $result['date'],
                        'total' => $total
                    );
                }
                ...
                foreach ($rejected as $result) {
                    ...
                    $order_rejected[$result['date']] = array(
                        'day' => $result['date'],
                        'total' => $total
                    );
                }
                ...
                foreach ($fullfilled as $result) {
                    ...
                    $order_fullfilled[$result['date']] = array(
                        'day' => $result['date'],
                        'total' => $total
                    );
                }
                ...
                $i = 0;
                foreach ($order_assigned as $key => $value) {
                    $json['order']['assigned'][] = array($i++, $value['total']);
                }
                
                $i = 0;
                foreach ($order_rejected as $key => $value) {
                    $json['order']['rejected'][] = array($i++, $value['total']);
                }
                
                $i = 0;
                foreach ($order_fullfilled as $key => $value) {
                    $json['order']['fullfilled'][] = array($i++, $value['total']);
                }
            ...
            case 'month':
                ...
                for ($i = 0; $i < count($months); $i++) {
                    ...
                    $order_assigned[$months[$i]] = array(
                        'month' => $months[$i],
                        'total' => 0
                    );
                    
                    $order_rejected[$months[$i]] = array(
                        'month' => $months[$i],
                        'total' => 0
                    );
                    
                    $order_fullfilled[$months[$i]] = array(
                        'month' => $months[$i],
                        'total' => 0
                    );
                ...
                foreach ($assigned as $result) {
                    $order_assigned[$result['month']] = array(
                        'month' => $result['month'],
                        'total' => $result['total']
                    );
                }
                ...
                foreach ($rejected as $result) {
                    $order_rejected[$result['month']] = array(
                        'month' => $result['month'],
                        'total' => $result['total']
                    );
                }
                ...
                foreach ($fullfilled as $result) {
                    $order_fullfilled[$result['month']] = array(
                        'month' => $result['month'],
                        'total' => $result['total']
                    );
                }
            ...
            case 'year':
                ...
                foreach ($assigned as $result) {
                    $order_assigned[$result['year']] = array(
                        'year' => $result['year'],
                        'total' => $result['total']
                    );
                }
                ...
                foreach ($rejected as $result) {
                    $order_rejected[$result['year']] = array(
                        'year' => $result['year'],
                        'total' => $result['total']
                    );
                }
                ...
                foreach ($fullfilled as $result) {
                    $order_fullfilled[$result['year']] = array(
                        'year' => $result['year'],
                        'total' => $result['total']
                    );
                }
