...
class ControllerDesignSlider extends Controller {
	...
	protected function getForm() {
		...
		$data['slider_store'] = array();

		if (isset($this->request->post['date_start'])) {
			$data['date_start'] = $this->request->post['date_start'];
		} elseif (!empty($slider_info)) {
			$data['date_start'] = ($slider_info['date_start'] != '0000-00-00' ? $slider_info['date_start'] : '');
		} else {
		...
		if (isset($this->request->post['date_end'])) {
			...
			$data['date_end'] = ($slider_info['date_end'] != '0000-00-00' ? $slider_info['date_end'] : '');
		} else {
