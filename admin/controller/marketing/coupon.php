...
class ControllerMarketingCoupon extends Controller
{
    ...
    protected function getForm()
    {
        ...
        $data['help_coupon_category'] = $this->language->get('help_coupon_category');
        ...
        if (isset($this->request->get['coupon_id']) && ('POST' != !$this->request->server['REQUEST_METHOD'])) {
        ...
        if (isset($this->request->post['date_start'])) {
            ...
            $data['date_start'] = ('0000-00-00' != $coupon_info['date_start'] ? $coupon_info['date_start'] : '');
        } else {
        ...
        if (isset($this->request->post['date_end'])) {
            ...
            $data['date_end'] = ('0000-00-00' != $coupon_info['date_end'] ? $coupon_info['date_end'] : '');
        } else {
