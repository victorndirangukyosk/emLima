...
class ControllerMarketingMarketing extends Controller
{
    ...
    public function add()
    {
        ...
        if (('POST' == $this->request->server['REQUEST_METHOD']) && $this->validateForm()) {
            $marketing_id = $this->model_marketing_marketing->addMarketing($this->request->post);
    ...
    protected function getForm()
    {
        ...
        if (isset($this->request->get['marketing_id']) && ('POST' != $this->request->server['REQUEST_METHOD'])) {
