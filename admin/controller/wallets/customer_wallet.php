...
class Controllerwalletscustomerwallet extends Controller
{
    private $error = [];

    public function index()
    {
        $this->load->language('wallets/customer_wallet');
    ...
    protected function getList()
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('wallets/customer_wallet', 'token='.$this->session->data['token'].$url, 'SSL'),
        ];
        ...
        $data['sort_name'] = $this->url->link('wallets/customer_wallet', 'token='.$this->session->data['token'].'&sort=name'.$url, 'SSL');
        $data['sort_email'] = $this->url->link('wallets/customer_wallet', 'token='.$this->session->data['token'].'&sort=c.email'.$url, 'SSL');
        $data['sort_date_added'] = $this->url->link('wallets/customer_wallet', 'token='.$this->session->data['token'].'&sort=date_added'.$url, 'SSL');
        ...
        $pagination->url = $this->url->link('wallets/customer_wallet', 'token='.$this->session->data['token'].$url.'&page={page}', 'SSL');
        ...
        $this->response->setOutput($this->load->view('wallets/customer_wallet.tpl', $data));
    }
