...
class ControllerTotalTransactionFee extends Controller
{
    ...
    public function index()
    {
        ...
        $data['action'] = $this->url->link('total/transaction_fee', 'token='.$this->session->data['token'], 'SSL');
        ...
        $this->response->setOutput($this->load->view('total/transaction_fee.tpl', $data));
    }
