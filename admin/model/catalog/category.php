...
class ModelCatalogCategory extends Model {
    ...
    public function getCategoryByStoreByCategoryId($store_id, $category_id) {
        $sql = 'SELECT cts.category_id FROM ' . DB_PREFIX . 'category_to_store cts LEFT JOIN ' . DB_PREFIX . 'category_description cd on cts.category_id = cd.category_id where cts.store_id=' . $store_id . " and language_id = '" . (int) $this->config->get('config_language_id') . "' AND cts.category_id = '" . $category_id . "'";
