...
class ModelPaymentSagepayDirect extends Model
{
    ...
    public function void($order_id)
    {
        ...
        if (!empty($sagepay_direct_order) && 0 == $sagepay_direct_order['release_status']) {
            $void_data = [];
    ...
    public function release($order_id, $amount)
    {
        ...
        if (!empty($sagepay_direct_order) && 0 == $sagepay_direct_order['release_status'] && ($total_released + $amount <= $sagepay_direct_order['total'])) {
            $release_data = [];
    ...
    public function rebate($order_id, $amount)
    {
        ...
        if (!empty($sagepay_direct_order) && 1 != $sagepay_direct_order['rebate_status']) {
            $refund_data = [];
