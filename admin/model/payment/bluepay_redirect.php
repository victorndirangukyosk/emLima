...
class ModelPaymentBluepayredirect extends Model
{
    ...
    public function void($order_id)
    {
        ...
        if (!empty($bluepay_redirect_order) && 0 == $bluepay_redirect_order['release_status']) {
            $void_data = [];
            ...
            $void_data['APPROVED_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
            $void_data['DECLINED_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
            $void_data['MISSING_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
    ...
    public function release($order_id, $amount)
    {
        ...
        if (!empty($bluepay_redirect_order) && 0 == $bluepay_redirect_order['release_status'] && ($total_released + $amount <= $bluepay_redirect_order['total'])) {
            $release_data = [];
            ...
            $release_data['APPROVED_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
            $release_data['DECLINED_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
            $release_data['MISSING_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
    ...
    public function rebate($order_id, $amount)
    {
        ...
        if (!empty($bluepay_redirect_order) && 1 != $bluepay_redirect_order['rebate_status']) {
            $rebate_data = [];
            ...
            $rebate_data['APPROVED_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
            $rebate_data['DECLINED_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
            $rebate_data['MISSING_URL'] = HTTP_CATALOG.'index.php?path=payment/bluepay_redirect/callback';
    ...
    {
        if (1 == $this->config->get('bluepay_redirect_debug')) {
