...
class ModelDesignBlocks extends Model {
	...
	public function getBlockOls($block_id) {
		...
		foreach ($query->rows as $result) {
			...
			$block_data[$result['language_id']] = array('image' => $image,'thumb' => $thumb,'title' => $result['title'], 'description' => $result['description']);
		}
	...
	public function getBlock($block_id) {
		...
		foreach ($query->rows as $result) {
			...
			$block_data[$result['language_id']] = array('image' => $image,'thumb' => $thumb,'title' => $result['title'], 'description' => $result['description'],'sort_order' => $result['sort_order']);
