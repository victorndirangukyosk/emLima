...
class ModelDashboardCharts extends Model {
    ...
    public function getAccountManagerSales($date_start, $date_end, $group) {
        $complete_status_ids = '(' . implode(',', $this->config->get('config_complete_status')) . ')';
    ...
    public function getAccountManagerBookedSales($date_start, $date_end, $group) {
        $complete_status_ids = '(' . implode(',', $this->config->get('config_complete_status')) . ')';
    ...
    public function getTotalAccountManagerSales($date_start, $date_end) {
        $complete_status_ids = '(' . implode(',', $this->config->get('config_complete_status')) . ')';
    ...
    public function getAccountManagerOrders($date_start, $date_end, $group) {
        $complete_status_ids = '(' . implode(',', $this->config->get('config_complete_status')) . ')';
    ...
    public function getAccountManagerCreatedOrders($date_start, $date_end, $group) {
        if (isset($this->request->get['account_manager_id'])) {
            $account_manager_id = $this->request->get['account_manager_id'];
        } else {
            $account_manager_id = $this->user->getId();
    ...
    public function getAccountManagerCancelledOrders($date_start, $date_end, $group) {
        if (isset($this->request->get['account_manager_id'])) {
            $account_manager_id = $this->request->get['account_manager_id'];
        } else {
            $account_manager_id = $this->user->getId();
    ...
    public function getTotalAccountManagerOrders($date_start, $date_end) {
        $complete_status_ids = '(' . implode(',', $this->config->get('config_complete_status')) . ')';
