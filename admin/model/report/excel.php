...
class ModelReportExcel extends Model {
    ...
    public function download_customer_excel($data) {
        ...
        try {
            ...
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, 4, 'Sno.');
            ...
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, 4, 'Telephone');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, 4, 'Status');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, 4, 'Approved');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, 4, 'Customer Group');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, 4, 'Date Added');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, 4, 'Source');
            ...
            foreach ($rows as $result) {
                ...
                //     $result['company_name'] = ' (' . $result['company_name'] . ')';
                // }
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $row, $index);
                // if ($result['company_name'])
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $result['email']);
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $result['telephone']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $result['status'] ? 'Enabled' : 'Disabled');
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $row, $result['approved']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $row, $result['customer_group']);

                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $row, date($this->language->get('date_format_short'), strtotime($result['date_added'])));
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $row, $result['source']);
                ++$row;
                ++$index;
            }
    ...
    public function download_product_wastage_excel_consolidated($filter_data) {
        ...
        try {
            ...
            foreach ($rows as $result) {
                ...
                $new_data['filter_date_added'] = $filter_data['filter_date_added'];
                $new_data['filter_date_added_end'] = $filter_data['filter_date_added_to'];

                $this->load->model('inventory/inventory_wastage');
                $average_buying_price = $this->model_inventory_inventory_wastage->getProductAverageBuyingPrice($new_data);

                $log = new Log('error.log');
                $log->write('DATA_PRODUCT_2');
                $log->write($average_buying_price);
                $log->write('DATA_PRODUCT_2');
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, ($result['avg_buying_price'] == NULL || $result['avg_buying_price'] == 0 ? round($average_buying_price['average_buying_price'], 2) : round($result['avg_buying_price'], 2)));
    ...
    public function download_receivables_summary_excel($data) {
        ...
        try {
            ...
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, 3, 'Region');
            ...
            foreach ($rows as $result) {
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $result['payment_terms']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $result['region']);
    ...
    public function download_receivables_ageing_excel($data) {
        ...
        try {
            ...
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, 3, 'Company');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, 3, 'Customer');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, 3, 'Payment Terms');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, 3, 'Region');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, 3, 'Sum of Total');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, 3, 'Sum not Due');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, 3, 'Sum of 0-30');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, 3, 'Sum of 31-60');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, 3, 'Sum of 61-90');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, 3, 'Sum of 91-180');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, 3, 'Sum of 181-360');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, 3, 'Sum of >360');
            ...
            foreach ($rows as $result) {
                ...
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $row, $result['customer']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $result['payment_terms']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $result['region']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, $row, $result['total']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(6, $row, $result['not_due']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(7, $row, $result['sum_30']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(8, $row, $result['sum_60']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(9, $row, $result['sum_90']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $row, $result['sum_180']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(11, $row, $result['sum_360']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(12, $row, $result['sum_360_greater']);
    ...
    public function download_product_entry_excel($data) {
        $this->load->library('excel');
        $this->load->library('iofactory');

        $this->load->language('common/productentry');
        $this->load->model('common/productentry');
        $rows = $this->model_common_productentry->getProductEntries($data);
        ...
        try {
            ...
            //Company name, address
            $objPHPExcel->getActiveSheet()->mergeCells('A1:F2');
            $objPHPExcel->getActiveSheet()->setCellValue('A1', 'Product Entries');
            $objPHPExcel->getActiveSheet()->getStyle('A4:F4')->applyFromArray(['font' => ['bold' => true], 'color' => [
                    'rgb' => '4390df',
            ]]);
            ...
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, 4, 'Product Entery Id');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, 4, 'Product Name');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, 4, 'UoM');

            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, 4, 'Source');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, 4, 'Quantity');
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(5, 4, 'Price');
            ...
            $row = 5;
            foreach ($rows as $result) {
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(0, $row, $result['product_entry_id']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(1, $row, $result['product_name']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(2, $row, $result['unit']);

                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(3, $row, $result['source']);
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(4, $row, $result['quantity'] );
