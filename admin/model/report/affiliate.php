...
class ModelReportAffiliate extends Model
{
    ...
    {
        $sql = "SELECT at.affiliate_id, CONCAT(a.firstname, ' ', a.lastname) AS affiliate, a.email, a.status, SUM(at.amount) AS commission, COUNT(o.order_id) AS orders, SUM(o.total) AS total FROM ".DB_PREFIX.'affiliate_commission at LEFT JOIN `'.DB_PREFIX.'affiliate` a ON (at.affiliate_id = a.affiliate_id) LEFT JOIN `'.DB_PREFIX.'order` o ON (at.order_id = o.order_id)';
    ...
    {
        $sql = 'SELECT COUNT(DISTINCT affiliate_id) AS total FROM `'.DB_PREFIX.'affiliate_commission`';
    ...
    {
        $sql = "SELECT at.product_id, CONCAT(a.firstname, ' ', a.lastname) AS affiliate, a.email, a.status, SUM(at.amount) AS commission, COUNT(o.order_id) AS orders, SUM(o.total) AS total FROM ".DB_PREFIX.'affiliate_commission at LEFT JOIN `'.DB_PREFIX.'affiliate` a ON (at.affiliate_id = a.affiliate_id) LEFT JOIN `'.DB_PREFIX.'order` o ON (at.order_id = o.order_id) LEFT JOIN '.DB_PREFIX.'product';
    ...
    {
        $sql = 'SELECT COUNT(DISTINCT product_id) AS total FROM `'.DB_PREFIX.'affiliate_commission`';
