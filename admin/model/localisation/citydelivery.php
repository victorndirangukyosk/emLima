...
class ModelLocalisationCitydelivery extends Model {
    ...
    public function editCitydelivery($city_id, $data) {
        ...
        $tuesday = in_array("monday", $data['city_delivery']) ? 1 : 0;
        $wednesday = in_array("monday", $data['city_delivery']) ? 1 : 0;
        $thursday = in_array("monday", $data['city_delivery']) ? 1 : 0;
        $friday = in_array("monday", $data['city_delivery']) ? 1 : 0;
        $saturday = in_array("monday", $data['city_delivery']) ? 1 : 0;
        $sunday = in_array("monday", $data['city_delivery']) ? 1 : 0;
