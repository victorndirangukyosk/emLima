...
class ModelSettingStore extends Model {
    ...
    public function addStore($data) {
        ...
        foreach ($data['storeCategories'] as $cat_id) {
            ...
            if($this->db->query($sqlTemp)->row['total'] == 0) {
    ...
    function getOpenHoursStatus( $timeslot, $day, $store_id ) {
    ...
    function getPickupStatus( $timeslot, $day, $store_id ) {
    ...
    function getStoreIds( $vendor_id ) {
