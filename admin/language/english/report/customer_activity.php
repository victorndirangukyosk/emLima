...
$_['text_sub_user_deactivated'] = '<a href="customer_id=%d">%s</a> de-activated a <a href="sub_customer_id=%d">sub customer</a>.';
$_['text_sub_user_activated'] = '<a href="customer_id=%d">%s</a> activated a <a href="sub_customer_id=%d">sub customer</a>.';
$_['text_sub_user_deleted'] = '<a href="customer_id=%d">%s</a> deleted a <a href="sub_customer_id=%d">sub customer</a>.';
$_['text_assign_head_chef'] = '<a href="customer_id=%d">%s</a> assigned a <a href="sub_customer_id=%d">head chef</a>.';
$_['text_assign_procurement_person'] = '<a href="customer_id=%d">%s</a> assigned a <a href="sub_customer_id=%d">procurement person</a>.';
$_['text_sub_customer_created'] = '<a href="customer_id=%d">%s</a> created a <a href="sub_customer_id=%d">sub customer</a>.';
// Column
