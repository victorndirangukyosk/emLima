    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        ...
        <div class="pull-right">
          <button type="button" data-toggle="tooltip" title="Show Filter" class="btn btn-primary btn-sm"
            id="showFilter"><i class="fa fa-eye"></i></button>
          <button type="button" data-toggle="tooltip" title="Hide Filter" class="btn btn-primary btn-sm"
            id="hideFilter"><i class="fa fa-eye-slash"></i></button>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="filter_group_name" value="<?php echo $filter_group_name; ?>"
                  placeholder="Email Group Name" id="input-group-name" class="form-control" />
              </div>
            </div>
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-group-description">Group Description</label>
                <input type="text" name="filter_group_description" value="<?php echo $filter_group_description; ?>"
                  placeholder="Group Description" id="input-group-description" class="form-control" />
              </div>
