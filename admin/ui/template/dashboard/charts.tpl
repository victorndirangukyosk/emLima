  ...
  <div class="panel-body">
      <div id="tab_toolbar" class="panel-body" style="width: 100%; display: table; color: #555555;">
            ...
            <?php if($this->user->isVendor()) { ?>
                    <dl onclick="getChart(this, 'sales');" class="col-xs-4 col-lg-4 active" style="background-color: #008db9">
            <?php } else { ?>
          ...
          <?php if($this->user->isVendor()) { ?>
                    <dl onclick="getChartX(this, 'sales');" class="col-xs-4 col-lg-4 passive">
            <?php } else { ?>

                <dl onclick="getChartX(this, 'sales');" class="col-xs-4 col-lg-4 passive">

            <?php } ?>
              <dt>Created Orders</dt>
              <dd class="data_value size_l"><span id=""> Count: </span><span id="created_orders_total"><?= $todaysCreatedOrders['total'] ?> </span></dd>
              <dd class="data_value size_l"><span id="">Value: </span><span id="created_orders_value"> <?= $todaysCreatedOrders['value'] ?> </span></dd>
          ...
          <?php if($this->user->isVendor()) { ?>
            ...
            <dl onclick="getChartX(this, 'customers');" class="col-xs-4 col-lg-4 passive">
                <dt>Cancelled Orders</dt>
                <dd class="data_value size_l"><span id=""> Count: </span><span id="cancelled_orders_total"><?= $todaysCancelledOrders['total'] ?> </span></dd>
