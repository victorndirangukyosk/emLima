        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-coupon" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_coupon_category; ?>"><?php echo $entry_coupon_category; ?></span></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($coupon_type == 'd') { ?>
                    <input type="radio" name="coupon_type" value="d" checked="checked" />
                    <?php echo $text_deduct; ?>
                    <?php } else { ?>
                    <input type="radio" name="coupon_type" value="d" />
                    <?php echo $text_deduct; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if ($coupon_type == 'c') { ?>
                    <input type="radio" name="coupon_type" value="c" checked="checked" />
                    <?php echo $text_cashback; ?>
                    <?php } else { ?>
                    <input type="radio" name="coupon_type" value="c" />
                    <?php echo $text_cashback; ?>
                    <?php } ?>
                  </label>
                </div>
...
$('#history').load('index.php?path=marketing/coupon/history&token=<?php echo $token; ?>&coupon_id=<?php echo $coupon_id; ?>');
//--></script>
  <?php } ?>
  <script type="text/javascript"><!--
$('.date').datetimepicker({
