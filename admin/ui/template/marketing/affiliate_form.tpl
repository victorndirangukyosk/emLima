...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?path=marketing/affiliate/country&token=<?php echo $token; ?>&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
...
$('#commission').load('index.php?path=marketing/affiliate/commission&token=<?php echo $token; ?>&affiliate_id=<?php echo $affiliate_id; ?>');

$('#button-commission').on('click', function() {
	$.ajax({
		url: 'index.php?path=marketing/affiliate/commission&token=<?php echo $token; ?>&affiliate_id=<?php echo $affiliate_id; ?>',
		type: 'post',
		dataType: 'html',
