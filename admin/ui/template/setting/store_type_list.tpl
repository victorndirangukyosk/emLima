          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($category['store_type_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['store_type_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['store_type_id']; ?>" />
                    <?php } ?></td>
...
$('#button-filter').on('click', function() {
    url = 'index.php?path=setting/store_type&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
    'source': function(request, response) {
        $.ajax({
            url: 'index.php?path=setting/store_type/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
            dataType: 'json',
