        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-testimonial">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                 ...
                 <!-- <td class="text-left"><?= $column_name ?></td>-->
                  <td class="text-left"><?= $column_summary ?></td>
                  <td class="text-left"><?= $column_business_impact ?></td>
                  <td class="text-left"><?= $column_is_customer_requirement ?></td>
              ...
              <tbody>
                <?php if ($newfeatures) { ?>
                <?php foreach ($newfeatures as $newfeature) { ?>
                <tr>
                   ...
                   <input type="checkbox" name="selected[]" value="<?php echo $testimonial['testimonial_id']; ?>" checked="checked" />
                    ...
                    <?php } ?></td>-->
                  <!--<td class="text-left"><?php echo $newfeature['name']; ?></td>-->
                  <td class="text-left"><?php echo $newfeature['summary']; ?></td>
                  <td class="text-left"><?php echo $newfeature['business_impact']; ?></td>
                  <td class="text-left"><?php echo $newfeature['is_customer_requirement']; ?></td>
                 ...
                 <!-- <td class="text-left">
                  ...
                  <td class="text-right">
                      <a href="<?php echo $newfeature['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      </td>
                </tr>
                <?php } ?>
                <?php } else { ?>
