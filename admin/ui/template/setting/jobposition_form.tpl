...
<div id="content">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-job_category"><?= $column_job_category ?></label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-job_type"><?= $column_job_type ?></label>
                        <div class="col-sm-4">
                     ...
                     <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-job_location"><?= $column_job_location ?></label>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-skills"><?= $column_skills ?></label>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group required">
                        <label class="col-sm-2 control-label" for="input-roles_responsibilities"><?= $column_roles_responsibilities ?></label>
                        <div class="col-sm-6">
                      ...
                      <div class="form-group ">
                        <label class="col-sm-2 control-label" for="input-otherinfo_1"><?= $column_otherinfo_1 ?></label>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group ">
                        <label class="col-sm-2 control-label" for="input-otherinfo_2"><?= $column_otherinfo_2 ?></label>
                        <div class="col-sm-4">
    ...
    function save(type) {
        ...
        $('#input-roles_responsibilities').summernote({
			height: 300
		});
