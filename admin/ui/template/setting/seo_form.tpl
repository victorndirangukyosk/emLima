        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-attribute" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">
                <?= $entry_query_url ?>
                <div class="help-block"><?= $text_url_part ?><br />(E.X., product_id=21)</div>
            </label>
            <div class="col-sm-10">
              <input type="text" name="query" value="<?php echo $query; ?>" placeholder="Query" id="input-sort-order" class="form-control" />
              <?php if ($error_query) { ?>
            ...
            <div class="col-sm-10">
              ...
              <div class="input-group">
                  <span class="input-group-addon">
                      <img src="ui/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
                  </span>
                  <input type="text" name="keywords[<?php echo $language['language_id']; ?>]" value="<?php echo isset($keywords[$language['language_id']]) ? $keywords[$language['language_id']] : ''; ?>" placeholder="Keyword" class="form-control" />
              </div>
              <?php if (isset($error_keywords[$language['language_id']])) { ?>
              <div class="text-danger"><?php echo $error_keywords[$language['language_id']]; ?></div>
              <?php } ?>
              <?php } ?>
            </div>
          </div>
