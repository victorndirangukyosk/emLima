  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-success"><i class="fa fa-plus"></i></a>
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-slider').submit() : false;"><i class="fa fa-trash-o"></i></button>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form-slider">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($slider['slider_id'], $selected)) { ?>
                  ...
                  <td class="text-left"><?php echo $slider['store_name']; ?></td>
                  <td class="text-left"><?php echo $slider['name']; ?></td>
                  <td class="text-left"><?php echo $slider['date_start']; ?></td>
                  <td class="text-left"><?php echo $slider['date_end']; ?></td>
                  <td class="text-left"><?php echo $slider['status']; ?></td>
                  <td class="text-right"><a href="<?php echo $slider['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?path=design/slider&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=design/slider/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
