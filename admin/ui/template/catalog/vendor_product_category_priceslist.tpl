                            ...
                            <tbody>
                                ...
                                <td class="text-right">
                                    <?php if(isset($product['category_price_status']) && $product['category_price_status'] == NULL) { ?>
                                     ...
                                     <button type="button" onclick="disableinallpricecategories('<?php echo $product['product_store_id'];?>','<?php echo $product['product_id'];?>','<?php echo $product['name']; ?>', 0)" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Disable In All Price Categories"><i class="fa fa-times-circle text-danger"></i></button>
                                     <?php } ?> 
                                    <?php if($this->user->hasPermission('modify', 'category/prices')){ ?>
...
<div id="addupdatecategorypricesModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div style="color: white;background-color: #008db9;" class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><strong>Add or Update Category Prices </strong></h4>
            </div>
            <div class="modal-body">
                <form id="addupdatecategorypricesModal" name="addupdatecategorypricesModal">
                    <div class="form-group required">
                        <label for="recipient-name" class="col-form-label">Company Name</label>
                        <input type="text" class="form-control" id="filter_company_name" name="filter_company_name" data-customer-id="" placeholder="Enter Company Name">
                        <input type="hidden" class="form-control" id="hidden_company_name" name="hidden_company_name">
                    </div>
                    
                    <div class="form-group">
                        <label class="control-label" for="input-category">Product Category</label>
                    ...
                    <div class="form-group required">
                        <label for="recipient-name" class="col-form-label">Product</label>
                        <input type="hidden" class="form-control" id="hidden_vendor_product_name" name="hidden_vendor_product_name">
                        <input type="text" class="form-control" id="filter_vendor_product_name" name="filter_vendor_product_name" placeholder="Enter Product Name">
                    </div>
                    
                    <div class="form-group required">
                        <label for="recipient-name" class="col-form-label">Price</label>
                        <input type="number" class="form-control" id="filter_vendor_product_price" name="filter_vendor_product_price" disabled="">
                    </div>
                    
                    <div class="form-group required">
                        <label for="recipient-name" class="col-form-label">Special Price</label>
                        <input type="number" class="form-control" id="filter_vendor_product_special_price" name="filter_vendor_product_special_price" disabled="">
                    </div>
                    
                    <div class="form-group required">
                        <label for="recipient-name" class="col-form-label">Discount Percentage</label>
                        <input type="number" step="0.01" class="form-control" id="filter_vendor_product_discount" name="filter_vendor_product_discount" onkeyup="getDiscountPrice();">
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" id="add_discount" name="add_discount" disabled>Add New</button>
            </div>
        </div>
...
$('input[name=\'filter_vendor_product_name\']').prop( "disabled", true );
$('select[name=\'filter_product_category\']').prop( "disabled", true );
...
$('button[name=\'add_discount\']').prop( "disabled", true );
});        
...
$('input[name=\'filter_company_name\']').autocomplete({
    'source': function(request, response) {
        $.ajax({
            url: 'index.php?path=dropdowns/dropdowns/autocompleteparentcustomer&token=<?php echo $token; ?>&filter_company_name=' + encodeURIComponent(request),
            dataType: 'json',
            success: function(json) {
                response($.map(json, function(item) {
                    return {
    ...
    'select': function(item) {
        ...
        $('input[name=\'filter_company_name\']').attr('data-customer-id', item['value']);
        $('input[name=\'hidden_company_name\']').val(item['value']);
        $('select[name=\'filter_product_category\']').prop("disabled", false);
        
        if($('select[name=\'filter_product_category\']').val() > 0 && $('input[name=\'filter_company_name\']').val() != '') {
        $('input[name=\'filter_vendor_product_name\']').prop( "disabled", false);
        $('button[name=\'add_discount\']').prop( "disabled", false );
        }
    }
});

$('select[name=\'filter_product_category\']').on('change', function() {
        if($('select[name=\'filter_product_category\']').val() > 0 && $('input[name=\'filter_company_name\']').val() != '') {
        $('input[name=\'filter_vendor_product_name\']').prop( "disabled", false);
        $('button[name=\'add_discount\']').prop( "disabled", false );
        }
...
$('input[name=\'filter_vendor_product_name\']').autocomplete({
    'source': function(request, response) {
        $.ajax({
            url: 'index.php?path=dropdowns/dropdowns/autocompletevendorproducts&filter_name='+encodeURIComponent(request)+'&filter_category='+encodeURIComponent($('select[name=\'filter_product_category\']').val())+'&token=<?php echo $token; ?>',
            dataType: 'json',
            success: function(json) {
                response($.map(json, function(item) {
                    return {
                        label: item['product_name']+' - '+item['unit'],
    ...
    'select': function(item) {
        console.log(item);
        $('input[name=\'filter_vendor_product_name\']').val(item['label']);
        $('input[name=\'filter_vendor_product_name\']').attr('data-product-store-id', item['value']);
        $('input[name=\'hidden_vendor_product_name\']').val(item['value']);
        $('input[name=\'filter_vendor_product_price\']').val(item['price']);
        $('input[name=\'filter_vendor_product_special_price\']').val(item['special_price']);
        $('input[name=\'filter_vendor_product_special_price\']').attr('data-vendor-product-special-price', item['special_price']);
    }
});

 function getDiscountPrice() {
            var numVal1 = Number($('#filter_vendor_product_special_price').attr('data-vendor-product-special-price'));
            var numVal2 = Number($('#filter_vendor_product_discount').val()) / 100;
            var totalValue = numVal1 - (numVal1 * numVal2);
            console.log(totalValue);
            $('#filter_vendor_product_special_price').val(totalValue.toFixed(2));
 }
...
function addupdatecategoryprices(){
    $('#addupdatecategorypricesModal').modal('toggle');
    
    $('#filter_company_name').val('');
    $('#filter_product_category').val('');
    $('#filter_vendor_product_name').val('');
    $('#filter_vendor_product_price').val('');
    $('#filter_vendor_product_special_price').val('');
    $('#filter_vendor_product_discount').val('');
}                    
...
$('button[name^=\'add_discount\']').on('click', function () {

if($('select[name=\'filter_product_category\']').val() == '' || $('input[name=\'filter_company_name\']').val() == '' || $('input[name=\'filter_vendor_product_discount\']').val() == '') {
$('.alert.alert-danger').html('<i class="fa fa-times-circle text-danger"></i>All Fileds Are Mandatory!');
$('.alert.alert-danger').show();
console.log('Validation Failed!');
return false;
...
if($('input[name=\'filter_vendor_product_name\']').val() != '' && $('input[name=\'filter_vendor_product_discount\']').val() == '') {
$('.alert.alert-danger').html('<i class="fa fa-times-circle text-danger"></i>All Fileds Are Mandatory!');
$('.alert.alert-danger').show();
console.log('Validation Failed!');
return false;
...
$.ajax({
            url: 'index.php?path=catalog/vendor_product/adddiscount&token=<?php echo $token; ?>',
            dataType: 'json',
            type: "POST",
            data: $("form[id^='addupdatecategorypricesModal']").serialize(),
            success: function(json) {
                if (json) {
                $('.alert.alert-success').html('<i class="fa fa-check-circle text-success"></i> Successfully Product Added To Price Category!');
                $('.alert.alert-success').show();
...
function disableinallpricecategories(product_store_id,product_id,product_name,status, price_category){
	
        $.ajax({
                url: 'index.php?path=catalog/vendor_product/disableinallpricecategories&token=<?= $token ?>',
                dataType: 'json',
                data: { product_store_id :product_store_id, product_id : product_id, product_name : product_name, status : status },
                success: function(json) {
                    if (json) {
