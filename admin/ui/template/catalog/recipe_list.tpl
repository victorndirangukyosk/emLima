            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'r.title') { ?>
                    <a href="<?php echo $sort_title; ?>" class="<?php echo strtolower($order); ?>"><?= $column_title ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_title; ?>"><?= $column_title ?></a>
                    <?php } ?></td>
                  
                  <td class="text-left"><?php if ($sort == 'r.author') { ?>
                    <a href="<?php echo $sort_author; ?>" class="<?php echo strtolower($order); ?>"><?= $column_author ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_author; ?>"><?= $column_author ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $recipe['author']; ?></td>
                  <td class="text-right"><?php echo $recipe['sort_order']; ?></td>                  
                  <td class="text-right">
                      <a href="<?php echo $recipe['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
