    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button type="button" onclick="$('.message_wrapper').html('');" type="button" data-target="#store_modal" data-toggle="modal" class="btn btn-default"><i class="fa fa-copy"></i></button>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><a <?php if(!$this->user->hasPermission('modify', 'catalog/product')) { ?> disabled <?php } ?> href="<?php echo $product['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                                </tr>
                                <?php } ?>
                                <?php } else { ?>
                                <tr>
