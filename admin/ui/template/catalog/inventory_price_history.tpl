...
<div id="content">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $column_buying_price; ?></td>
                                    <td class="text-left"><?php echo $column_prev_buying_price; ?></td>
                                    <td class="text-left"><?php echo $column_source; ?></td>
                                    <td class="text-left"><?php echo $column_prev_source; ?></td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-left"><?php echo $histor['buying_price']; ?></td>
                                    <td class="text-left"><?php echo $histor['prev_buying_price']; ?></td>
                                    <td class="text-left"><?php echo $histor['source']; ?></td>
                                    <td class="text-left"><?php echo $histor['prev_source']; ?></td>
  ...
  $('#button-filter').on('click', function () {
            url = 'index.php?path=catalog/vendor_product/InventoryPriceHistory&token=<?php echo $token; ?>';
  ...
  $('.date').datetimepicker({
        ...
        function excel() {
            ...
            url = 'index.php?path=catalog/vendor_product/InventoryPriceHistoryexcel&token=<?php echo $token; ?>';
