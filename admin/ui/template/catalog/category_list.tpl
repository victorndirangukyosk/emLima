...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-success"><i class="fa fa-plus"></i></a> <a href="<?php echo $repair; ?>" data-toggle="tooltip" title="<?php echo $button_rebuild; ?>" class="btn btn-default"><i class="fa fa-refresh"></i></a>
...
function changeStatus(status){
	$.ajax({
		url: 'index.php?path=common/edit/changeStatus&type=category&status='+ status +'&token=<?php echo $token; ?>',
		dataType: 'json',
...
$('#button-filter').on('click', function() {
    url = 'index.php?path=catalog/category&token=<?php echo $token; ?>';
