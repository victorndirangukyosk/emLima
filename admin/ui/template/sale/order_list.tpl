    ...
    <div class="page-header">
        <div class="container-fluid">
            <div class="pull-right">
                ...
                <button type="" onclick="downloadOrderStickers();" id="button-order-pdf" form="form-order" formaction="<?php echo $sticker; ?>" data-toggle="tooltip" title="Download Order Stickers" class="btn btn-default"><i class="fa fa-print"></i></button>
