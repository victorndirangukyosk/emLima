                                    ...
                                    <?php endif ?>  
                                     ...
                                     <?php 
                                       ...
                                       <a href="#" target="_blank" data-toggle="tooltip" title="Amitruck" data-orderid="<?= $order['order_id'] ?>" data-ordertotal="<?= $order['sub_total_custom'] ?>" id="assign_to_amitruck">
                                        ...
                                        <?php } ?>
                                        <a href="#" target="_blank" data-toggle="tooltip" title="Products List" data-orderid="<?= $order['order_id'] ?>" data-order-product-list="<?php echo $order['invoice']; ?>" id="order_products_list">
