...
<div class="timeslotModal-popup">
  ...
  $(document).delegate('#save_order_transaction_id', 'click', function() {
	...
	$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/save_order_transaction_id&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		data: data,
		beforeSend: function() {
...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/createinvoiceno&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-add', 'click', function() {
	$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/addreward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-remove', 'click', function() {
	$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/removereward&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-add', 'click', function() {
	$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/addcommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/removecommission&token=<?php echo $token; ?>&order_id=<?php echo $order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
<script>
	...
	$(document).delegate('#settle_payment', 'click', function() {
		...
		if(confirm('Are You Sure?')) {
			...
			$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/settle_payment&token=<?php echo $token; ?>',
		type: 'post',
	...
	function status($store_id,$status_value, $status_text){
		if(confirm('Are You Sure?')){
			$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/status&token=<?php echo $token; ?>',
		type: 'post',
	...
	function payment_status($store_id,$status){
		...
		if(confirm('Are You Sure?')){
			$.ajax({
		url: 'index.php?path=sale/accountmanageruserorders/payment_status&token=<?php echo $token; ?>',
		type: 'post',
...
function get_ts($store_id, $date){
	$.post('<?= HTTP_SERVER ?>index.php?path=sale/accountmanageruserorders/get_home_ts&token=<?= $token ?>',{ store_id: $store_id, date: $date }, function(data){
...
$('.delivery_timeslot').change(function(){
  ...
  $.post('<?= HTTP_SERVER ?>index.php?path=sale/accountmanageruserorders/save_timeslots&order_id=<?= $order_id ?>&token=<?= $token ?>', $('.delivery_date, .delivery_timeslot').serialize());    
