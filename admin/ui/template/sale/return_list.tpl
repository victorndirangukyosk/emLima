            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'r.product') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'r.unit') { ?>
                  ...
                  <!-- <td class="text-left"><?php if ($sort == 'r.model') { ?>
                    ...
                    <!-- <td class="text-left"><?php if ($sort == 'r.store') { ?>
                    ...
                    <?php } ?></td> -->
                    <td class="text-left"><?php echo $column_store; ?>
                    </td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $return['unit']; ?></td>
                  <td class="text-left"><?php echo $return['store_name']; ?></td>
...
$('#button-filter').on('click', function() {
  url = 'index.php?path=sale/return&token=<?php echo $token; ?>';
