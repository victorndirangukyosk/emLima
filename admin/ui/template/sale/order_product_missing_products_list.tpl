                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="header">  <td colspan="11"><center><h3 class="my-order-title label" style="background-color: #ff2a00a8;display: block;line-height: 2;" id="order-status-id" data-download-invoice="<?= $this->url->link('sale/order_product_missing_products/invoice', 'token=' . $this->session->data['token'] . '&order_id=' . $key, 'SSL')?>" ><?= $key?> </h3>   </center></td> </tr>
