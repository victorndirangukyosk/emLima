    ...
    <table class="table table-bordered table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center"><a href="#" data-toggle="tooltip" title="Un Assign Customer" id="unassigncustomer" data-accountmanager="<?php echo $assignedcustomer['account_manager_id']; ?>" data-customer="<?php echo $assignedcustomer['customer_id']; ?>" class="btn btn-primary"><i class="fa fa-minus"></i></a></td>
            </tr>
            <?php } ?>
            <?php } else { ?>
            <tr>
