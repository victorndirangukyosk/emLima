...
$('#history').load('index.php?path=sale/kibanda/history&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');

$('#button-history').on('click', function(e) {
  e.preventDefault();

  $.ajax({
    url: 'index.php?path=sale/kibanda/history&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>',
    type: 'post',
    dataType: 'html',
...
$('#credit').load('index.php?path=sale/kibanda/credit&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');
...
$('#button-credit').on('click', function(e) {
  ...
  e.preventDefault();
        ...
        $.ajax({
    url: 'index.php?path=sale/kibanda/credit&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>',
    type: 'post',
    dataType: 'html',
...
$('#reward').load('index.php?path=sale/kibanda/reward&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');
...
$('#referral').load('index.php?path=sale/kibanda/referral&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');
...
$('#button-reward').on('click', function(e) {
  ...
  $.ajax({
    url: 'index.php?path=sale/kibanda/reward&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>',
    type: 'post',
    dataType: 'html',
...
$('#ip').load('index.php?path=sale/kibanda/customerviewip&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');

$('body').delegate('.button-ban-add', 'click', function() {
  var element = this;

  $.ajax({
    url: 'index.php?path=sale/kibanda/addbanip&token=<?php echo $token; ?>',
    type: 'post',
    dataType: 'json',
...
$('#activity').load('index.php?path=sale/kibanda/customerviewactivity&token=<?php echo $token; ?>&customer_id=<?php echo $customer_id; ?>');
