...
$('#button-send').on('click', function() {
	$.ajax({
		url: 'index.php?path=sale/voucher/send&token=<?php echo $token; ?>',
		type: 'post',
		dataType: 'json',
...
$('#history').load('index.php?path=sale/voucher/history&token=<?php echo $token; ?>&voucher_id=<?php echo $voucher_id; ?>');
//--></script>
  <?php } ?>
</div>
<?php echo $footer; ?>