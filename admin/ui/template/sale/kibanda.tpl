              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php if ($customer['approve']) { ?>
                    ...
                    <?php } } else { ?>
                    <a target="_blank" href="#" class="customer_verified" data-toggle="tooltip" title="Verified"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#51AB66" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-user-check"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="8.5" cy="7" r="4"></circle><polyline points="17 11 19 13 23 9"></polyline></svg></a>
