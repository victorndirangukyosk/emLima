...
<div id="content">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-return" class="form-horizontal">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-general">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                            <input type="text" name="store" value="<?php echo $store; ?>" placeholder="<?php echo $entry_store; ?>" id="input-store" class="form-control" disabled/>

                                            <input type="hidden" name="store" value="<?php echo $store; ?>"/>

                                            <span class="input-group-btn">
                                                <button type="button" onclick="openStore('<?php echo $store_id; ?>')" class="btn btn-default"><i class="fa fa-eye"></i></button>
                                            </span></div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="input-group date">
                                            <input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" placeholder="<?php echo $entry_date_ordered; ?>" data-date-format="YYYY-MM-DD" id="input-date-ordered" class="form-control" disabled />

                                            <input type="hidden" name="date_ordered" value="<?php echo $date_ordered; ?>"  data-date-format="YYYY-MM-DD"/>
                                ...
                                <?php if(!$this->user->isVendor()){ ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="customer" value="<?php echo $customer; ?>" placeholder="<?php echo $entry_customer; ?>" id="input-customer" class="form-control" disabled />
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-firstname" class="form-control" disabled />
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname" class="form-control" disabled />
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="input-customer"><?php echo $entry_customer; ?></label>
                                        <div class="col-sm-10">
                                            <input type="text" name="customer" value='<?php echo strtok($firstname, " "); ?>' placeholder="<?php echo $entry_customer; ?>" id="input-customer" class="form-control" disabled />
                                ...
                                <?php if (!$this->user->isVendor()){ ?> 
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>" id="input-email" class="form-control" disabled />
                            ...
                            <fieldset>
                                ...
                                <div class="form-group required">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="product" value="<?php echo $product; ?>" placeholder="<?php echo $entry_product; ?>" id="input-product" class="form-control" disabled />
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="input-model"><?php echo $entry_unit; ?></label>
                                    <div class="col-sm-10">
                                        <input type="text" name="unit" value="<?php echo $unit; ?>" placeholder="<?php echo $entry_unit; ?>" id="input-model" class="form-control" disabled/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="model" value="<?php echo $model; ?>" placeholder="<?php echo $entry_model; ?>" id="input-model" class="form-control" disabled />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="quantity" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control" disabled/>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="input-return-reason"><?php echo $entry_return_reason; ?></label>
                                        <div class="col-sm-10">
                                            <select name="return_reason_id" id="input-return-reason" class="form-control" disabled>
                                                <?php foreach ($return_reasons as $return_reason) { ?>
                                                <?php if ($return_reason['return_reason_id'] == $return_reason_id) { ?>
                                                <option value="<?php echo $return_reason['return_reason_id']; ?>" selected="selected"><?php echo $return_reason['name']; ?></option>
                                                <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label" for="input-opened"><?php echo $entry_opened; ?></label>
                                        <div class="col-sm-10">
                                            <select name="opened" id="input-opened" class="form-control" disabled>
                                                <?php if ($opened) { ?>
                                                <option value="1" selected="selected"><?php echo $text_opened; ?></option>
                                                <option value="0"><?php echo $text_unopened; ?></option>
                                                <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" disabled="">
                                            <textarea name="comment" rows="5" placeholder="<?php echo $entry_comment; ?>" id="input-comment" class="form-control" disabled><?php echo $comment; ?></textarea>
                                        </div>
                                    </div>

                                    <input type="hidden" name="return_reason_id" value="<?php echo $return_reason_id; ?>" />
                                    <input type="hidden" name="opened" value="<?php echo $opened; ?>"  />
                        ...
                        <div class="tab-pane" id="tab-history">
                            ...
                            <?php if( !($this->user->isVendor() && $return_status_id ==  3)){ ?>
                            ...
                            <fieldset>
                                ...
                                <div class="text-right">
                                    <button id="button-history" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-danger" disabled><i class="fa fa-plus-circle"></i> <?php echo $button_history_add; ?></button>
                                </div>
                            </fieldset>
  ...
  <script type="text/javascript"><!--
        ...
        var area = container.querySelector('#input-history-comment');
        if (area.addEventListener) {
          area.addEventListener('input', function() {
            // event handling code for sane browsers

            if ($('textarea[name=\'history_comment\']').val())
          { 
            $('#button-history').removeClass('btn-danger');
            $('#button-history').addClass('btn-primary');

            $('#button-history').removeAttr('disabled');
          } else {

            $('#button-history').addClass('btn-danger');
            $('#button-history').removeClass('btn-primary');
...
$('#history').load('index.php?path=sale/return/history&token=<?php echo $token; ?>&return_id=<?php echo $return_id; ?>');

$('#button-history').on('click', function(e) {
  e.preventDefault();

    $.ajax({
        url: 'index.php?path=sale/return/history&token=<?php echo $token; ?>&return_id=<?php echo $return_id; ?>',
        type: 'post',
        dataType: 'html',
