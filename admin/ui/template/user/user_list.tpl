...
$('#button-filter').on('click', function() {
	var url = 'index.php?path=user/user&token=<?php echo $token; ?>';
...
$('input[name=\'filter_user_group\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=user/user/autocomplete&token=<?php echo $token; ?>&filter_user_group=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_first_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=user/user/autocomplete&token=<?php echo $token; ?>&filter_first_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_last_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=user/user/autocomplete&token=<?php echo $token; ?>&filter_last_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
$('input[name=\'filter_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=user/user/autocomplete&token=<?php echo $token; ?>&filter_email=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
