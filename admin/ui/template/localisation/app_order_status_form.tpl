            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group"><span class="input-group-addon"><img src="ui/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                            <input type="text" name="app_order_status[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($app_order_status[$language['language_id']]) ? $app_order_status[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" class="form-control" />
                          </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <div class="input-group" style="max-width: 100%;"><span class="input-group-addon"><img src="ui/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /></span>
                              <textarea name="app_order_status[<?php echo $language['language_id']; ?>][message]" placeholder="<?php echo $entry_message; ?>" id="input-message-<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($app_order_status[$language['language_id']]) ? $app_order_status[$language['language_id']]['message'] : ''; ?></textarea>
                          </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="app_order_status[<?php echo $language['language_id']; ?>][sort_order]" value="<?php echo isset($app_order_status[$language['language_id']]) ? $app_order_status[$language['language_id']]['sort_order'] : ''; ?>" placeholder="Sort Order" id="input-sort-order" class="form-control" />
                      </div>
                    </div>
