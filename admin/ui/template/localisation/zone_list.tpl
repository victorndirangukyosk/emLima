...
$('#button-filter').on('click', function() {
	var url = 'index.php?path=localisation/zone&token=<?php echo $token; ?>';
...
$('input[name=\'filter_country\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=localisation/zone/autocomplete&token=<?php echo $token; ?>&filter_country=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('input[name=\'filter_zone_code\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=localisation/zone/autocomplete&token=<?php echo $token; ?>&filter_zone_code=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
