...
?>
      ...
      <div id="<?php echo $module_key; ?>">
        <div class="vtabs">
          ...
          <?php $module_row++; ?>
          <?php } ?>
          <span id="module-add-<?php echo $module_key; ?>"><?php echo $button_add_module; ?>&nbsp;<img src="ui/image/add.png" alt="" onclick="addModuleCategory();" /></span> </div>
        <?php $module_row = 1; ?>
        <?php foreach ($modules as $module) { ?>
