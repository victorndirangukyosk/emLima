...
?>
      ...
      <div id="<?php echo $module_key; ?>">
        <div class="vtabs">
          ...
          <?php $module_row++; ?>
          <?php } ?>
          <span id="module-add-<?php echo $module_key; ?>"><?php echo $button_add_module; ?>&nbsp;<img src="ui/image/add.png" alt="" onclick="addModuleComment();" /></span> </div>
        <?php $module_row = 1; ?>
...
function addModuleComment() {	
	...
	$('#module-add-<?php echo $module_key; ?>').before('<a href="#tab-module-<?php echo $module_key; ?>-' + module_row_comment + '" id="module-<?php echo $module_key; ?>-' + module_row_comment + '"><?php echo $this->language->get("tab_module"); ?> ' + module_row_comment + '&nbsp;<img src="ui/image/delete.png" alt="" onclick="$(\'.vtabs a:first\').trigger(\'click\'); $(\'#module-<?php echo $module_key; ?>-' + module_row_comment + '\').remove(); $(\'#tab-module-<?php echo $module_key; ?>-' + module_row_comment + '\').remove(); return false;" /></a>');
