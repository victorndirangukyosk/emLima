									...
									<ol>	
										<li>
											<div><b><?php echo $this->language->get('text_front_page');?></b></div>
											 ...
											 <?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?path=pavblog/blogs";?><br>
										...
										<li>
											...
											<?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?path=pavblog/category&id=";?>CATEGORY_ID <br>
										...
										<li>
											...
											<?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?path=pavblog/blog/id=";?>BLOG_ID<br>
										...
										<li>
											...
											<?php echo $this->language->get('text_normal');?>: <?php echo HTTPS_CATALOG."index.php?path=pavblog/blogs&tag=";?><b>TAG_NAME</b><br>
