...
$('input[name=\'pavblog_category-manufacturer\']').autocomplete({
	...
	source: function(request, response) {		
		$.ajax({
			url: 'index.php?path=catalog/manufacturer/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
...
$('input[name=\'pavblog_category-product\']').autocomplete({
	...
	source: function(request, response) {		
		$.ajax({
			url: 'index.php?path=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					'product_id':  0,
...
$('input[name=\'path\']').autocomplete({
	...
	source: function(request, response) {		
		$.ajax({
			url: 'index.php?path=catalog/category/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {
				json.unshift({
					'category_id':  0,
