...
$('#install').on('click', function(e){
	...
	//	 path : 'D:\xampp\htdocs\instacart/vendors/codemanager',
		 username : 'admin',
...
$('#showModal').on('click', function(e){
	...
	$("#CustomerData").load('index.php?path=module/<?php echo $moduleNameSmall; ?>/givecredentials&token=<?php echo $token; ?>');
});
