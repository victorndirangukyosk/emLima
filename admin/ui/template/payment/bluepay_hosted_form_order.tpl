  ...
  $("#button-void").click(function() {
		if (confirm('<?php echo $text_confirm_void; ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/bluepay_hosted_form/void&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-void').hide();
	...
	$("#button-release").click(function() {
		if (confirm('<?php echo $text_confirm_release; ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/bluepay_hosted_form/release&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-release').hide();
					$('#release_amount').hide();
	...
	$("#button-rebate").click(function() {
		if (confirm('<?php echo $text_confirm_rebate ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/bluepay_hosted_form/rebate&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-rebate').hide();
					$('#rebate_amount').hide();
