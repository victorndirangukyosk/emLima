  ...
  $("#button-void").click(function() {
		if (confirm('<?php echo $text_confirm_void; ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/sagepay_server/void&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-void').hide();
	...
	$("#button-release").click(function() {
		if (confirm('<?php echo $text_confirm_release; ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/sagepay_server/release&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-release').hide();
					$('#release_amount').hide();
	...
	$("#button-rebate").click(function() {
		if (confirm('<?php echo $text_confirm_rebate ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/sagepay_server/rebate&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#button-rebate').hide();
					$('#rebate_amount').hide();
