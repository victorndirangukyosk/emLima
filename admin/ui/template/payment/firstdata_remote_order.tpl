...
$('#button-void').bind('click', function () {
	if (confirm('<?php echo $text_confirm_void; ?>')) {
		$.ajax({
			...
			url: 'index.php?path=payment/firstdata_remote/void&token=<?php echo $token; ?>',
			beforeSend: function() {
				$('#button-void').hide();
...
$('#button-capture').bind('click', function () {
	if (confirm('<?php echo $text_confirm_capture; ?>')) {
		...
		dataType: 'json',
		data: {'order_id': <?php echo $order_id; ?> },
		url: 'index.php?path=payment/firstdata_remote/capture&token=<?php echo $token; ?>',
		beforeSend: function() {
		$('#button-capture').hide();
...
$('#button-refund').bind('click', function () {
	if (confirm('<?php echo $text_confirm_refund; ?>')) {
		...
		dataType: 'json',
		data: {'order_id': <?php echo $order_id; ?> },
		url: 'index.php?path=payment/firstdata_remote/refund&token=<?php echo $token; ?>',
		beforeSend: function() {
		$('#button-refund').hide();
