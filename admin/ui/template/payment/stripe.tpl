        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-pilibaba" class="form-horizontal">
		  ...
		  <div class="tab-content">
		    <div class="tab-pane active" id="tab-settings">
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-stripe-live-secret-key"> Stripe connect Platform ID</label>
                  <div class="col-sm-10">
                  <input type="text" name="stripe_connect_platform_id" value="<?php echo $stripe_connect_platform_id; ?>" placeholder="Stripe connect Platform ID" id="input-stripe_connect_platform_id" class="form-control" />
                  </div>
              </div>
