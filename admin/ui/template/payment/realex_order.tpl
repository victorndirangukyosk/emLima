  ...
  $("#button-void").click(function () {
    if (confirm('<?php echo $text_confirm_void; ?>')) {
      $.ajax({
        ...
        url: 'index.php?path=payment/realex/void&token=<?php echo $token; ?>',
        beforeSend: function() {
          $('#button-void').hide();
          $('#loading-void').show();
  ...
  $("#button-capture").click(function () {
    if (confirm('<?php echo $text_confirm_capture; ?>')) {
      $.ajax({
        ...
        url: 'index.php?path=payment/realex/capture&token=<?php echo $token; ?>',
        beforeSend: function() {
          $('#button-capture').hide();
          $('#capture-amount').hide();
  ...
  $("#button-rebate").click(function () {
    if (confirm('<?php echo $text_confirm_rebate ?>')) {
      $.ajax({
        ...
        url: 'index.php?path=payment/realex/rebate&token=<?php echo $token; ?>',
        beforeSend: function() {
          $('#button-rebate').hide();
          $('#rebate-amount').hide();
          $('#loading-rebate').show();
