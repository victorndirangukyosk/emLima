  ...
  $("#btn_void").click(function() {
		if (confirm('<?php echo $text_confirm_void; ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/securetrading_pp/void&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#btn_void').hide();
	...
	$("#btn_release").click(function() {
		if (confirm('<?php echo $text_confirm_release; ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/securetrading_pp/release&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#btn_release').hide();
					$('#release_amount').hide();
	...
	$("#btn_rebate").click(function() {
		if (confirm('<?php echo $text_confirm_rebate ?>')) {
			$.ajax({
				...
				url: 'index.php?path=payment/securetrading_pp/rebate&token=<?php echo $token; ?>',
				beforeSend: function() {
					$('#btn_rebate').hide();
					$('#rebate_amount').hide();
