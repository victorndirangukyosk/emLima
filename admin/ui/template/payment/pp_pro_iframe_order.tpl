    ...
    function capture() {
        ...
        if (amt == '' || amt == 0) {
            ...
            $.ajax({
                ...
                url: 'index.php?path=payment/pp_pro_iframe/capture&token=<?php echo $token; ?>',
                beforeSend: function() {
                    $('#button-capture').hide();
    ...
    function doVoid() {
        if (confirm('<?php echo $text_confirm_void; ?>')) {
            $.ajax({
                ...
                url: 'index.php?path=payment/pp_pro_iframe/void&token=<?php echo $token ?>',
                beforeSend: function() {
                    $('#button-void').hide();
...
function reauthorise() {
    $.ajax({
        ...
        dataType: 'json',
        data: {'order_id':<?php echo $order_id; ?> },
        url: 'index.php?path=payment/pp_pro_iframe/reauthorise&token=<?php echo $token; ?>',
        beforeSend: function() {
