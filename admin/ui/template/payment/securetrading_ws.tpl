...
<script type="text/javascript">
	function downloadTransactions() {
		...
		$('#transaction-form').attr('action', 'index.php?path=payment/securetrading_ws/downloadTransactions&token=<?php echo $token ?>');
	...
	function showTransactions() {
		$.ajax({
			url: 'index.php?path=payment/securetrading_ws/showTransactions&token=<?php echo $token ?>',
			type: 'post',
