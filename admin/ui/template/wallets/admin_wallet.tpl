              ...
              <tbody>
                ...
                <tr>
                  <!-- <td class="text-center"><?php if (in_array($customer['customer_id'], $selected)) { ?>
                    ...
                    <?php } ?></td> -->
                  <!-- <td class="text-left"><a href="<?= $link_admin.'&user_id='.$customer['customer_id'] ?>"><?php echo $customer['name']; ?></a></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=wallets/admin_wallet&token=<?php echo $token; ?>';
...
$('input[name=\'filter_name\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=wallets/admin_wallet/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
...
$('input[name=\'filter_email\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=wallets/admin_wallet/autocomplete&token=<?php echo $token; ?>&filter_email=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
