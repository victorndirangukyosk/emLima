              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['name']; ?>
                   <br/> <?php echo $customer['company']; ?></td>
                  <!--<td class="text-left"><?php echo $customer['email']; ?></td>-->
                  <td class="text-right"><?php echo $customer['amount']; ?></td>
                  ...
                  <td class="text-left"><?php echo $customer['order_id']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/customer_wallet&token=<?php echo $token; ?>';
...
function excel() {
       url = 'index.php?path=report/customer_wallet/customerwalletexcel&token=<?php echo $token; ?>';
