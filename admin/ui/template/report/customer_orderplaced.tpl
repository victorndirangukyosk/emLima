...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/customer_orderplaced&token=<?php echo $token; ?>';
...
function excel() {
      	url = 'index.php?path=report/customer_orderplaced/orderplacedexcel&token=<?php echo $token; ?>';
