        ...
        <div class="well" style="display:none;">
          <div class="row">
           ...
           <div class="row" hidden> <div class="col-sm-8">
               <p>Note : List of Customers who ordered for the first time in the selected date range and their first order ID and order date</p>  
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/customer_onboarded&token=<?php echo $token; ?>';
...
alert('Please select customer registration - Start Date');
return;
  }
...
alert('Please select customer registration - End Date');
return;
  }
...
function excel() {
      	url = 'index.php?path=report/customer_onboarded/customeronboardedexcel&token=<?php echo $token; ?>';
