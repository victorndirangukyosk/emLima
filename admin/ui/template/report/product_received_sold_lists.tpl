...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            ...
            <h1>Products received and consumed/Sold</h1>
            <ul class="breadcrumb">
 ...
 <div class="form-group">
  ...
  $('#button-filter').on('click', function() {
            ...
            var url = 'index.php?path=report/product_received_sold&token=<?php echo $token; ?>';
...
function excel() {
            ...
            var url = 'index.php?path=report/product_received_sold/excel&token=<?php echo $token; ?>';
       var filter_name = $('input[name=\'filter_name\']').val();
