...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/sale_shipping&token=<?php echo $token; ?>';
...
$('.date').datetimepicker({
	...
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=report/sale_shipping/city_autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
function excel() {
  url = 'index.php?path=report/sale_shipping/excel&token=<?php echo $token; ?>';
