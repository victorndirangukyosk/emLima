                ...
                <div class="well" style="display:none;max-height:310px !important;" >
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="input-order-date">Order Date</label>
                                <div class="input-group date">
                                    <input type="text" name="filter_date_added" value="<?php echo $filter_date_added; ?>" placeholder="Order Date" data-date-format="YYYY-MM-DD" id="input-order-date" class="form-control" />
...
$('#button-filter').on('click', function () {
            url = 'index.php?path=report/order_product_missing_products&token=<?php echo $token; ?>';
...
function downloadmissingproducts() {
            ...
            url = 'index.php?path=report/order_product_missing_products/downloadmissingproducts&token=<?php echo $token; ?>';
