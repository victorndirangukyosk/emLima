...
<div id="content">
            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php if ($store_sales) { ?>
                            <?php foreach ($store_sales as $order) { ?>
                            <tr>
	...
	'select': function(item) {
        ...
        $('#button-filter').on('click', function() {
            ...
            url = 'index.php?path=report/store_sales&token=<?php echo $token; ?>';
        ...
        function excel() {
            ...
            url = 'index.php?path=report/store_sales/excel&token=<?php echo $token; ?>';
