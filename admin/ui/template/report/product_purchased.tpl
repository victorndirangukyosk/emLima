...
<div id="content">
  ...
  <script type="text/javascript"><!--
	...
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=report/product_purchased/city_autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/product_purchased&token=<?php echo $token; ?>';
