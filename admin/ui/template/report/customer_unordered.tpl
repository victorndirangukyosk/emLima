...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/customer_unordered&token=<?php echo $token; ?>';
...
function excel() {
      	url = 'index.php?path=report/customer_unordered/customerunorderedexcel&token=<?php echo $token; ?>';
