...
<div id="content">
  ...
  <script type="text/javascript"><!--
	...
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?path=report/sale_coupon/city_autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/sale_coupon&token=<?php echo $token; ?>';
