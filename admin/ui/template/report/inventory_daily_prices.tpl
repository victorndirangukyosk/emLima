        ...
        <div class="well" style="display:none;">
          <div class="row">
              ...
              <div class="<?php echo $is_vendor ? 'col-sm-4' : 'col-sm-4' ?>">
                ...
                <div class="input-group date">
                  <input style="width: 285px;" type="text" name="filter_date_end" value="<?php echo $filter_date_end; ?>" placeholder="<?php echo $entry_date_end; ?>" data-date-format="YYYY-MM-DD" id="input-date-end" class="form-control" />
                  <span class="input-group-btn">
                  <button type="button" class="btn btn-default"><i class="fa fa-calendar"></i></button>
                  </span></div>
              </div>
