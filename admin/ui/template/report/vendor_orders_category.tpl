...
<div id="content">
    <div class="page-header">
        <div class="container-fluid">
            <h1>Ordered Products By Category Report</h1>
            <ul class="breadcrumb">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="fa fa-bar-chart"></i> Ordered Products By Category</h3>
    ...
    <script type="text/javascript">
        ...
        $("#download-consolidated-order-sheet").click(function(e) {
            ...
            if (!deliveryDate.length > 0) {
                ...
                const url = 'index.php?path=report/vendor_orders/consolidatedOrderSheetGroupByCategory&token=<?php echo $token; ?>&filter_delivery_date=' + encodeURIComponent(deliveryDate) +'&filter_delivery_time_slot=' + encodeURIComponent(deliveryTime);
                location = url;
            }
        });
