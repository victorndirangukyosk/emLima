...
<div id="content">
                ...
                <div class="well" style="display:none;">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label class="control-label"><?= $entry_vendor ?></label>
                                <input name="vendor_name" value="<?= $filter_vendor ?>" class="form-control" />
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <td class="left"><?= $column_vendor ?></td>  
                                <?php  } ?>
                                <td class="left"><?php echo $column_date_start; ?></td>
                                <td class="left"><?php echo $column_date_end; ?></td>
                                <td class="right">
                                    <?php if ($sort == 'orders') { ?>
                                    <a href="<?php echo $sort_orders; ?>" class="<?php echo strtolower($order); ?>"><?= $column_orders ?></a>
                                    <?php } else { ?>
                                    <a href="<?php echo $sort_orders; ?>"><?= $column_orders ?></a>
                                    <?php } ?>
                                </td>
                                <td class="right">
                                    <?php if ($sort == 'products') { ?>
                                    <a href="<?php echo $sort_products; ?>" class="<?php echo strtolower($order); ?>"><?= $column_products ?></a>
                                    <?php } else { ?>
                                    <a href="<?php echo $sort_products; ?>"><?= $column_products ?></a>
                                    <?php } ?>
                                </td>
                                <td class="right">
                                    <?php if ($sort == 'subtotal') { ?>
                                    <a href="<?php echo $sort_subtotal; ?>" class="<?php echo strtolower($order); ?>"><?= $column_subtotal ?></a>
                                    <?php } else { ?>
                                    <a href="<?php echo $sort_total; ?>"><?= $column_subtotal ?></a>
                                    <?php } ?>
                                </td>
                                <td class="right">
                                    <?php if ($sort == 'total') { ?>
	...
	'select': function(item) {
        ...
        $('#button-filter').on('click', function() {
            ...
            url = 'index.php?path=report/vendor_order&token=<?php echo $token; ?>';
        ...
        function excel() {
            ...
            url = 'index.php?path=report/vendor_order/excel&token=<?php echo $token; ?>';
