          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <td class="text-left"><?php echo $column_return; ?></td>
                <td class="text-right"><?php echo $column_return_date; ?></td>
                <td class="text-right"><?php echo $column_return_amount; ?></td>
              </tr>
            </thead>
            <tbody>
              <?php if ($returns) { ?>
              ...
              <tr>
                ...
                <td class="text-right"><?php echo $return['return_date']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/vendor_returns&token=<?php echo $token; ?>';
  ...
  function excel() {
      ...
      url = 'index.php?path=report/vendor_returns/excel&token=<?php echo $token; ?>';
