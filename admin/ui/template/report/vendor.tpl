        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-left"><?php echo $vendor['date_start']; ?></td>
                <td class="text-left"><?php echo $vendor['date_end']; ?></td>
                <td class="text-right"><?php echo $vendor['total']; ?></td>
              </tr>
              <?php } ?>
              <?php } else { ?>
              <tr>
...
$('#button-filter').on('click', function() {
	url = 'index.php?path=report/vendor&token=<?php echo $token; ?>';
...
function excel() {
	url = 'index.php?path=report/vendor/excel&token=<?php echo $token; ?>';
