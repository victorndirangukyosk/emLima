  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-shopping-cart"></i>Shop</h3>
      </div>
      <div class="panel-body">
          <?php if (!empty($updates['core'])) { ?>
                <h4><?php echo $text_update_core; ?></h4> <a href="<?php echo $update.'&product_id=core&version='.$updates['core']; ?>" data-toggle="tooltip" title="<?php echo $button_core; ?>" class="btn btn-warning"><i class="fa fa-refresh"></i> &nbsp;<?php echo $button_core; ?></a>
          <?php } else { ?>
