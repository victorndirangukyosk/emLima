(function ( $ ) {
    ...
    var GmUtility = {
        ...
        address_component_from_google_geocode: function(address_components) {
            ...
            for (var i = address_components.length-1; i>=0; i--) {
                ...
                // State \ Province
                else if (component.types.indexOf('establishment') >= 0) {
                    result.establishment = component.short_name;
                }
            }   
            ...
            if(result.streetNumber && result.streetName) {
                ...
                result.addressLine1 = result.streetName;
            }
            
            result.addressLine2 = '';

            /*if(result.addressLine1) {
                $('#street').val(result.addressLine1);
                $('#edit-street').val(result.addressLine1);
            }

            if(result.city) {
                $('#picker_city_name').val(result.city);
            }*/

            console.log('address_component_from_google_geocode');
            console.log(result);
    ...
    function updateInputValues(inputBinding, gmapContext){
        ...
        if (inputBinding.locationNameInput) {
            ...
            if(gmapContext.addressComponents.streetNumber && false) {
                inputBinding.locationNameInput.val(gmapContext.addressComponents.streetNumber+' '+gmapContext.addressComponents.streetName).change();    
            } else {
                //inputBinding.locationNameInput.val(gmapContext.locationName).change();
            }
            
            //inputBinding.locationNameInput.val(gmapContext.addressComponents.streetName).change();
            //comment above u want to have exact address from the autocomplete
        }
    ...
    function setupInputListenersInput(inputBinding, gmapContext) {
        if (inputBinding) {
            ...
            if (inputBinding.locationNameInput && gmapContext.settings.enableAutocomplete) {
                var blur = false;
                gmapContext.autocomplete = new google.maps.places.Autocomplete(inputBinding.locationNameInput.get(0),gmapContext.options);
            ...
            switch (options) {
                case "location":
                    if (params == undefined) { // Getter
                        ...
                        location.addressComponents = gmapContext.addressComponents;
