    ...
    switch ($_GET['action']) {
        ...
        ?>
            ...
            <select name="access_level" onchange="if($(this).val()=='0'){ $('#project-selector').slideUp(300); }else{ $('#project-selector').slideDown(300).css({'overflow-y':'scroll'}); }">
                <option value="0" <?php if (!$projects_assigned) {
            echo 'selected="selected"';
        } ?>><?php i18n('Access ALL Projects'); ?></option>
                <option value="1" <?php if ($projects_assigned) {
            echo 'selected="selected"';
        } ?>><?php i18n('Only Selected Projects'); ?></option>
            </select>
            <div id="project-selector" <?php if (!$projects_assigned) {
        ...
        ?>
            ...
            <label><?php i18n('Confirm Password'); ?></label>
            <input type="password" name="password2">
          <button class="btn-left"><?php i18n('Change %{username}%&apos;s Password', ['username' => ucfirst($username)]); ?></button>
