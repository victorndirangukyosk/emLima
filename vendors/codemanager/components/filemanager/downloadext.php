<?php
    ...
    */
    ...
    if (!isset($_GET['path'])
            ...
            || false !== strpos('..', $_GET['path'])) { // change directory up to escape Workspace
    ...
    if (isset($_GET['type']) && ('directory' == $_GET['type'] || 'root' == $_GET['type'])) {
        // Create tarball
        ...
        //////////////////////////////////////////////////////////////////
        if (isAvailable('system') && false === stripos(PHP_OS, 'win')) {
    ...
    // Remove temp tarball
    if ('directory' == $_GET['type'] || 'root' == $_GET['type']) {
