...
class User
{
    ...
    public function Authenticate()
    {
        ...
        if ($pass) {
            echo formatJSEND('success', ['username' => $this->username]);
        } else {
    ...
    public function Create()
    {
        ...
        if ($pass) {
            $this->users[] = ['username' => $this->username, 'password' => $this->password, 'project' => ''];
    ...
    public function Delete()
    {
        ...
        foreach ($this->users as $user => $data) {
            if ($data['username'] != $this->username) {
                $revised_array[] = ['username' => $data['username'], 'password' => $data['password'], 'project' => $data['project']];
            }
        }
    ...
    public function Password()
    {
        ...
        foreach ($this->users as $user => $data) {
            if ($data['username'] == $this->username) {
                $revised_array[] = ['username' => $data['username'], 'password' => $this->password, 'project' => $data['project']];
            } else {
                $revised_array[] = ['username' => $data['username'], 'password' => $data['password'], 'project' => $data['project']];
            }
        }
    ...
    public function Project()
    {
        ...
        foreach ($this->users as $user => $data) {
            if ($this->username == $data['username']) {
                $revised_array[] = ['username' => $data['username'], 'password' => $data['password'], 'project' => $this->project];
            } else {
                $revised_array[] = ['username' => $data['username'], 'password' => $data['password'], 'project' => $data['project']];
            }
        }
