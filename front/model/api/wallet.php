...
class ModelApiWallet extends Model
{
    ...
    public function getVendorWallet($data = array())
    {
    ...
    public function getAllVendorCreditsTotal($data = array()) {
        $sql = "SELECT CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.*,c.email  FROM " . DB_PREFIX . "user c  JOIN " . DB_PREFIX . "vendor_wallet cgd ON (c.user_id = cgd.vendor_id)";
    ...
    public function getAllCustomerCredits($data = array()) {
    ...
    public function getTotalCustomerWallet($data = array()) {
    ...
    public function getAllVendorCreditsByAdmin($data = array()) {
        $sql = "SELECT CONCAT(c.firstname, ' ', c.lastname) AS name, cgd.*,c.email  FROM " . DB_PREFIX . "user c  JOIN " . DB_PREFIX . "vendor_wallet cgd ON (c.user_id = cgd.vendor_id)";
    ...
    public function getTotalVendorWalletByAdmin($data = array()) {
