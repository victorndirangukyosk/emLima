...
class ModelApiStores extends Model
{
    ...
    public function editStore($store_id, $data) {
		...
		foreach($data as $key=>$value){
             ...
             if(in_array($key,array('city_id','user_group_id','store_pickup_timeslots'))){
               $value = (int)$value;
             }else if(in_array($key,array('latitude','longitute','name','pickup_notes'))){
