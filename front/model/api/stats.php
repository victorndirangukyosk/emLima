...
class ModelApiStats extends Model
{
    ...
    public function getAdminDailyOrders($data = array())
    {
        $sql = "SELECT COUNT(*) AS number, SUM(total) AS price FROM " . DB_PREFIX . "order";
    ...
    public function getAdminDailyProducts($data = array())
    {
        $sql = "SELECT COUNT(*) AS number FROM " . DB_PREFIX . "product";
    ...
    public function getAdminDailyCustomers($data = array())
    {
        $sql = "SELECT COUNT(*) AS number FROM " . DB_PREFIX . "customer";
    ...
    public function getAdminStats($sql, $data = array(), $type= '')
    {
        $stats = array();
