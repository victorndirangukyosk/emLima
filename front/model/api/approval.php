...
class ModelApiApproval extends Model
{
    ...
    public function moveVendorEndquiry($data) {
    ...
    public function getVendorApprovalTotal() {
        $query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "enquiries`");
        return $query->row['total'];
    }

    public function getAllVendorApproval($data = array()) {
    ...
    public function vendorApprovalDelete($enquiry_id) {
