...
class ModelAccountApi extends Model {
    ...
    public function login_send_otp() {
        ...
        if(strpos($this->request->post['phone'], '#') == false && !empty($this->request->post['phone'])) {
    ...
    public function phonenumber_send_otp() {
        ...
        if(strpos($this->request->post['new_phone'], '#') == false && !empty($this->request->post['new_phone'])) {
    ...
    public function register_send_otp() {
        ...
        //echo "<pre>";print_r($this->request->post);die;
        if ( ( $this->request->server['REQUEST_METHOD'] == 'POST' ) && $this->signup_validate() ) {
