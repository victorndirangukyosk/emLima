...
class ModelAccountOrder extends Model {
    ...
    public function getPezeshaloans() {
        $pezesha_loans = $this->db->query('SELECT p.loan_id,p.order_id,p.customer_id FROM ' . DB_PREFIX . "customer_pezesha_loans p join " . DB_PREFIX . "order o on p.order_id = o.order_id WHERE p.customer_id = " . $this->customer->getId());
