<?php
    ...
    class ModelSimpleBlogArticle extends Model
    {
        ...
        public function getTotalArticleCategoryWise($data = [])
        {
            $sql = $this->db->query('SELECT COUNT(DISTINCT(sba.simple_blog_article_id)) AS total FROM `'.DB_PREFIX.'simple_blog_article` sba LEFT JOIN `'.DB_PREFIX.'simple_blog_article_description` sbad ON(sba.simple_blog_article_id=sbad.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX.'simple_blog_article_to_store` sbas ON(sba.simple_blog_article_id=sbas.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX.'simple_blog_author` sbau ON(sba.simple_blog_author_id=sbau.simple_blog_author_id) LEFT JOIN `'.DB_PREFIX."simple_blog_article_to_category` sbac ON(sba.simple_blog_article_id=sbac.simple_blog_article_id) WHERE sbac.simple_blog_category_id='".(int) $data['simple_blog_article_id']."' AND sba.status=1 AND sbau.status=1 AND sbad.language_id='".$this->config->get('config_language_id')."'");

            return $sql->row['total'];
        }

        public function getArticleCategoryWise($data = [])
        {
        ...
        {
            $sql = $this->db->query('SELECT COUNT(DISTINCT(sba.simple_blog_article_id)) AS total FROM `'.DB_PREFIX.'simple_blog_article` sba LEFT JOIN `'.DB_PREFIX.'simple_blog_article_description` sbad ON(sba.simple_blog_article_id=sbad.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX.'simple_blog_article_to_store` sbas ON(sba.simple_blog_article_id=sbas.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX."simple_blog_author` sbau ON(sba.simple_blog_author_id=sbau.simple_blog_author_id) WHERE sba.simple_blog_author_id='".(int) $simple_blog_author_id."' AND sba.status=1 AND sbau.status=1 AND sbau.status=1 AND sbad.language_id='".$this->config->get('config_language_id')."'");

            return $sql->row['total'];
        }

        public function getArticleAuthorWise($data = [])
        {
            $sql = 'SELECT sba.*, sbad.*, sbau.name AS author_name FROM `'.DB_PREFIX.'simple_blog_article` sba LEFT JOIN `'.DB_PREFIX.'simple_blog_article_description` sbad ON(sba.simple_blog_article_id=sbad.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX.'simple_blog_article_to_store` sbas ON(sba.simple_blog_article_id=sbas.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX."simple_blog_author` sbau ON(sba.simple_blog_author_id=sbau.simple_blog_author_id) WHERE sba.simple_blog_author_id='".(int) $data['simple_blog_author_id']."' AND sba.status=1 AND sbau.status=1 AND sbad.language_id='".$this->config->get('config_language_id')."' ORDER BY sba.date_modified DESC";
        ...
        public function getArticleModuleWise($data = [])
        {
            $sql = 'SELECT sba.*, sbad.*, sbau.name AS author_name FROM `'.DB_PREFIX.'simple_blog_article` sba LEFT JOIN `'.DB_PREFIX.'simple_blog_article_description` sbad ON(sba.simple_blog_article_id=sbad.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX.'simple_blog_article_to_store` sbas ON(sba.simple_blog_article_id=sbas.simple_blog_article_id) LEFT JOIN `'.DB_PREFIX.'simple_blog_author` sbau ON(sba.simple_blog_author_id=sbau.simple_blog_author_id) LEFT JOIN `'.DB_PREFIX."simple_blog_article_to_category` sbac ON(sba.simple_blog_article_id=sbac.simple_blog_article_id) WHERE sba.status=1 AND sbau.status=1 AND sbad.language_id='".$this->config->get('config_language_id')."'";
        ...
        public function getPopularArticlesModuleWise($data = [])
        {
        ...
        public function getRelatedArticles($simple_blog_article_id)
        {
            ...
            $simple_blog_related_article_data = [];
