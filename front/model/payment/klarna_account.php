...
class ModelPaymentKlarnaAccount extends Model
{
    public function getMethod($total)
    {
        ...
        if ($status) {
            ...
            if ('NLD' == $address['iso_code_3'] && $this->currency->has('EUR') && $this->currency->format($total, 'EUR', '', false) > 250.00) {
                $status = false;
            }
        }
            ...
            foreach ($pclasses as $pclass) {
                ...
                if (2 == $pclass['type']) {
                    ...
                    if (3 == $pclass['type']) {
                        ...
                        $minimum_payment = (1 === $pclass['type']) ? $this->getLowestPaymentAccount($address['iso_code_3']) : 0;
