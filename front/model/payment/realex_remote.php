...
class ModelPaymentRealexRemote extends Model
{
    ...
    public function capturePayment($account, $amount, $currency, $order_id, $order_ref, $card_number, $expire, $name, $type, $cvv, $issue, $eci_ref, $eci = '', $cavv = '', $xid = '')
    {
        ...
        if (0 == $this->config->get('realex_remote_auto_settle')) {
            $xml .= '<autosettle flag="0" />';
        } elseif (1 == $this->config->get('realex_remote_auto_settle')) {
            $xml .= '<autosettle flag="1" />';
        } elseif (2 == $this->config->get('realex_remote_auto_settle')) {
        ...
        if (1 == $this->config->get('realex_remote_tss_check')) {
            $xml .= '<tssinfo>';
        ...
        if ('00' == $response->result) {
            ...
            if (1 == $this->config->get('realex_remote_auto_settle')) {
    ...
    {
        if (1 == $this->config->get('realex_remote_debug')) {
