...
class ModelPaymentSagePayServer extends Model
{
    ...
    public function updateRecurringPayment($item, $order_details)
    {
        ...
        if (1 == $item['trial'] && 0 != $item['trial_duration']) {
        ...
        if ($trial_end > $subscription_end && 0 != $item['recurring_duration']) {
        ...
        } elseif ($trial_end == $subscription_end && 0 != $item['recurring_duration']) {
    ...
    public function cronPayment()
    {
        ...
        foreach ($recurrings as $recurring) {
            ...
            if ('OK' == $response_data['RepeatResponseData_'.$i++]['Status']) {
    ...
    {
        if (1 == $this->config->get('sagepay_server_debug')) {
