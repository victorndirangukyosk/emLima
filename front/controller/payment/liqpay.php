...
class ControllerPaymentLiqPay extends Controller
{
    public function index()
    {
        ...
        $xml .= '	<result_url>'.$server.'checkout-success'.'</result_url>'; //$this->url->link('checkout/success', '', 'SSL')
        ...
        $xml .= '	<description>'.$this->config->get('config_name').' '.$order_info['firstname'].' '.$order_info['email'].'</description>';
