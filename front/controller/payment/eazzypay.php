...
class ControllerPaymentEazzypay extends Controller {
	public function index() {
        ...
        curl_setopt($curl, CURLOPT_HTTPHEADER, array('Content-type: application/x-www-form-urlencoded', 'AUTHORIZATION: Basic '.$enc));
...
(
    ...
    [hash] =>
		...
		if ($this->session->data['payment_method']['code'] == 'eazzypay') {
