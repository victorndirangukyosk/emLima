...
//pesapal params
         ...
         */
        $consumer_key = 'f2ifuLRM1Qxy8ViIszC77cdKu927A1zu'; //Register a merchant account on
        //demo.pesapal.com and use the merchant key for testing.
        //When you are ready to go live make sure you change the key to the live account
        //registered on www.pesapal.com!
        $consumer_secret = 'zF1JdH3NNwFjx/tghF4tB7LM8Ls='; // Use the secret from your test
...
//get form details
        ...
        $phonenumber = '+256772120556'; //ONE of email or phonenumber is required
        $Currency = 'KES';

        $callback_url = 'http://kwikbasket.test/redirect.php'; //redirect url, the page that will handle the response from pesapal.
...
//post transaction to pesapal
    ...
    public function checkPesapalStatus($order_id, $mpesa) {
