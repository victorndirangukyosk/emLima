...
class ControllerPaymentPesapal extends Controller {
    ...
    public function index() {
        ...
        $log->write($customer_info['telephone'] . 'CUSTOMER PHONE');
        $desc = 'KwikBasket';
        $type = 'MERCHANT'; //default value = MERCHANT,ORDER
        $reference = $order_id . time(); //unique order id of the transaction, generated by merchant
