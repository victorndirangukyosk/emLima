...
class ControllerPaymentPesapal extends Controller {
    ...
    public function index() {
        ...
        $desc = 'KwikBasket';
        $type = 'ORDER'; //default value = MERCHANT,ORDER
        $reference = $order_id; //unique order id of the transaction, generated by merchant
        $first_name = $customer_info['firstname'];
        $last_name = $customer_info['lastname'];
        $email = $customer_info['email'];
        $phonenumber = $customer_info['telephone']; //ONE of email or phonenumber is required
