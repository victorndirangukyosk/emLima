...
class ControllerPaymentFirstdataRemote extends Controller
{
    public function index()
    {
        ...
        if (1 == $this->config->get('firstdata_remote_card_storage') && $this->customer->isLogged()) {
            $data['card_storage'] = 1;
    ...
    public function send()
    {
        ...
        if (!isset($this->request->post['cc_choice']) || (isset($this->request->post['cc_choice']) && 'new' == $this->request->post['cc_choice'])) {
        ...
        if (empty($json['error'])) {
            ...
            if (isset($capture_result['transaction_result']) && 'APPROVED' == strtoupper($capture_result['transaction_result'])) {
                $json['success'] = $server.'checkout-success';
                ...
                if (1 == $this->config->get('firstdata_remote_auto_settle')) {
