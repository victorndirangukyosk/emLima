...
class ControllerPaymentRealexRemote extends Controller
{
    ...
    public function send()
    {
        ...
        if (3 != strlen($this->request->post['cc_cvv2']) && 4 != strlen($this->request->post['cc_cvv2'])) {
        ...
        if (isset($accounts[$this->request->post['cc_type']]['default']) && 1 == $accounts[$this->request->post['cc_type']]['default']) {
        ...
        if (1 == $this->config->get('realex_remote_3d')) {
            if ('visa' == $this->request->post['cc_type'] || 'mc' == $this->request->post['cc_type'] || 'amex' == $this->request->post['cc_type']) {
                ...
                if (isset($verify_3ds->result) && '00' == $verify_3ds->result) {
                    $enc_data = [
                        'account' => $account,
                        'amount' => $amount,
                        'currency' => $currency,
                ...
                if (isset($verify_3ds->result) && '110' == $verify_3ds->result && isset($verify_3ds->enrolled) && 'N' == $verify_3ds->enrolled) {
                    $eci_ref = 1;
                    $xid = '';
                    $cavv = '';
                    if ('mc' == $this->request->post['cc_type']) {
                        $eci = 1;
                    } else {
                        $eci = 6;
                    }
                ...
                if (isset($verify_3ds->result) && '110' == $verify_3ds->result && isset($verify_3ds->enrolled) && 'U' == $verify_3ds->enrolled) {
                    if (1 != $this->config->get('realex_remote_liability')) {
                        $this->load->language('payment/realex_remote');
    ...
    public function acsReturn()
    {
        if (isset($this->session->data['order_id'])) {
            ...
            if ('00' == $signature_result->result && ('Y' == strtoupper($signature_result->threedsecure->status) || 'A' == strtoupper($signature_result->threedsecure->status))) {
                if ('Y' == strtoupper($signature_result->threedsecure->status)) {
                    $eci_ref = 5;
                } else {
                    $eci_ref = 6;
                }
                ...
                if ('110' == $signature_result->result && 'Y' == strtoupper($signature_result->threedsecure->status)) {
                    $eci_ref = 4;
                    $cavv = (string) $signature_result->threedsecure->cavv;
                    $xid = (string) $signature_result->threedsecure->xid;
                }
                ...
                if ('00' == $signature_result->result && 'N' == strtoupper($signature_result->threedsecure->status)) {
                    $eci_ref = 7;
                    $xid = (string) $signature_result->threedsecure->xid;
                    $cavv = '';
                }
                ...
                if ('00' == $signature_result->result && 'U' == strtoupper($signature_result->threedsecure->status)) {
                    $eci_ref = 8;
                    $xid = (string) $signature_result->threedsecure->xid;
                    $cavv = '';
                }
                ...
                if (1 != $this->config->get('realex_remote_liability')) {
                    ...
                    if (1 == $this->config->get('realex_remote_card_data_status')) {
