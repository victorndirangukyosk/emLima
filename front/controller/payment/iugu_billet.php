...
*/
class ControllerPaymentIuguBillet extends Controller
{
    public function index()
    {
        ...
        $data['billet_download'] = $this->url->link('payment/iugu/download', '', 'SSL');

        /* Link para envio de Email */
        $data['billet_send_mail'] = $this->url->link('payment/iugu/sendMail', '', 'SSL');

        /* Mensagem de Sucesso */
        $data['billet_send_mail'] = $this->url->link('payment/iugu/sendMail', '', 'SSL');

        $data['continue'] = $this->url->link('payment/iugu_billet/confirm', '', 'SSL');

        return $this->load->view('default/template/payment/iugu_billet.tpl', $data);
    }
    ...
    */
    ...
    {
        if ('iugu_billet' == $this->session->data['payment_method']['code']) {
            $this->load->model('checkout/order');
            $this->load->model('payment/iugu');
