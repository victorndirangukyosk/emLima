...
class ControllerInformationInformation extends Controller
{
    public function index()
    {
        ...
        $information_info = $this->model_assets_information->getInformation($information_id);

        if ($information_info) {
            $title = empty($information_info['meta_title']) ? $information_info['title'] : $information_info['meta_title'];
