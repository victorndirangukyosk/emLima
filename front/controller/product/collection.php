...
class ControllerProductCollection extends Controller
{
    public function index()
    {
        ...
        if (isset($this->request->get['product_collection_id'])) {
            $product_collection_id = (int) $this->request->get['product_collection_id'];
        } else {
        ...
        //$product_collection_info = $this->model_assets_category->getProductCollectionDescriptions($product_collection_id);
        ...
        if ($product_collection_info) {
            ...
            $this->document->setDescription($product_collection_info['meta_description']);
            $this->document->setKeywords($product_collection_info['meta_keyword']);
            ...
            $data['heading_title'] = $product_collection_info['name'];
            ...
            $data['breadcrumbs'][] = [
                'text' => $product_collection_info['name'],
                'href' => $this->url->link('product/category', 'category='.$this->request->get['product_collection_id']),
            ];

            $data['description'] = html_entity_decode($product_collection_info['description'], ENT_QUOTES, 'UTF-8');
            ...
            if (false) {
                ...
                $product_total = $this->model_assets_product->getTotalCollectionProducts($filter_data);
            ...
            $data['sorts'][] = [
                ...
                'href' => $this->url->link('product/collection', 'product_collection_id='.$this->request->get['product_collection_id'].'&sort=p.sort_order&order=ASC'.$url),
            ];

            $data['sorts'][] = [
                'text' => $this->language->get('text_name_asc'),
                'value' => 'pd.name-ASC',
                'href' => $this->url->link('product/collection', 'product_collection_id='.$this->request->get['product_collection_id'].'&sort=pd.name&order=ASC'.$url),
            ];

            $data['sorts'][] = [
                'text' => $this->language->get('text_name_desc'),
                'value' => 'pd.name-DESC',
                'href' => $this->url->link('product/collection', 'product_collection_id='.$this->request->get['product_collection_id'].'&sort=pd.name&order=DESC'.$url),
            ];

            $data['sorts'][] = [
                'text' => $this->language->get('text_price_asc'),
                'value' => 'p.price-ASC',
                'href' => $this->url->link('product/collection', 'product_collection_id='.$this->request->get['product_collection_id'].'&sort=p.price&order=ASC'.$url),
            ];

            $data['sorts'][] = [
                'text' => $this->language->get('text_price_desc'),
                'value' => 'p.price-DESC',
                'href' => $this->url->link('product/collection', 'product_collection_id='.$this->request->get['product_collection_id'].'&sort=p.price&order=DESC'.$url),
            ];
            ...
            foreach ($limits as $value) {
                $data['limits'][] = [
                    'text' => $value,
                    'value' => $value,
                    'href' => $this->url->link('product/collection', 'product_collection_id='.$this->request->get['product_collection_id'].$url.'&limit='.$value),
                ];
            }
    ...
    public function getProducts($filter_data)
    {
        ...
        $results = $this->model_assets_product->getCollectionProducts($filter_data);
