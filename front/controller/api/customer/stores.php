...
class ControllerApiCustomerStores extends Controller
{
    ...
    public function getFindStoresbyCategoryId($args = array())
    {
    ...
    public function getFindStores($args = array())
    {
        $json = array();
    ...
    public function getFilterStores($args = array())
    {
        $json = array();
    ...
    public function getStoreHome($args = array())
    {
        $json = array();
    ...
    public function getAllOfferProducts($args = array())
    {
        $json = array();
        ...
        foreach ($store_types as $store_type) {
            ...
            foreach ($tempStores as $store) {
                ...
                if( in_array($store_type['store_type_id'],  explode(',', $store['store_type_ids']) ) ) {
                    ...
                    } elseif(count($deliveryTypesResponse) == 1) {
                            $deliveryTypes = $deliveryTypesResponse[0]['title'];
                            $deliveryTypeMethod = $deliveryTypesResponse[0]['code'];
                    }
