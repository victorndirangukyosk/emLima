	...
	public function addOrder($args =[]) {
		...
		if ( $this->validate($args) ) {
			...
			foreach ( $stores as $store_id ) {
				...
				if(isset($order_data[$store_id]['shipping_code']) && trim($order_data[$store_id]['shipping_code']) == 'express.express') {
	            	$order_data[$store_id]['delivery_date'] =  date('d-m-Y');
	...
	public function addValidateOrderDetail($args =[]) {
		...
		if(isset($args['stores'])) {
			...
			foreach ( $stores as $store_id ) {
				...
				if ($args['stores'][$store_id]['shipping_method'] == 'express.express') {
