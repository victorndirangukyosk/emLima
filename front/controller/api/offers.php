...
class ControllerApiOffers extends Controller
{
    ...
    public function getOffers($args = array())
    {
    ...
    public function getOffer($args = array())
    {
        ...
        if (!isset($this->session->data['api_id'])) {
            ...
            if (isset($this->request->post['date_start'])) {
                ...
                $data['date_start'] = ($offer_info['date_start'] != '0000-00-00' ? $offer_info['date_start'] : '');
            } else {
            ...
            if (isset($this->request->post['date_end'])) {
                ...
                $data['date_end'] = ($offer_info['date_end'] != '0000-00-00' ? $offer_info['date_end'] : '');
            } else {
    ...
    public function editOffer($args = array())
    {
    ...
    public function deleteOfferProduct($args = array())
    {
    ...
    public function deleteOfferDelete($args = array())
    {
    ...
    public function addOfferProduct($args = array())
    {
    ...
    public function addOfferCreate($args = array())
    {
