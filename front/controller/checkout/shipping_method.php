	...
	public function save() {
		...
		if (!$json) {
			...
			if (isset($this->session->data['shipping_method'][$store_id])) {
		        ...
		        if(isset($shipping[0]) && $shipping[0] == 'express') {
				...
				if ($found === false) {
				   $this->session->data['shipping_method'][$store_id] = array('store_id'=>$store_id,'shipping_method'=>$this->session->data['shipping_methods'][$store_id][$shipping[0]]['quote'][$shipping[1]] );
