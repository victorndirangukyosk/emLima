...
class ControllerFeedGoogleBase extends Controller
{
    public function index()
    {
        ...
        if ($this->config->get('google_base_status')) {
            ...
            $products = $this->model_assets_product->getProducts();
            ...
            foreach ($products as $product) {
                if ($product['description']) {
                    ...
                    $categories = $this->model_assets_product->getCategories($product['product_id']);
    ...
    {
        $category_info = $this->model_assets_category->getCategory($parent_id);
