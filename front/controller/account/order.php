...
class ControllerAccountOrder extends Controller {
    ...
    public function edit_your_order() {
        ...
        if ($order_info && $order_info['customer_id'] == $this->customer->getId() && ($order_info['order_status_id'] == 15 || $order_info['order_status_id'] == 14) && $hours <= 2 && $order_info['payment_code'] == 'cod') {
            $data['cashbackAmount'] = $this->currency->format(0);
