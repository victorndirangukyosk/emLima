...
class ControllerAccountRegister extends Controller
{
    ...
    public function validate()
    {
        ...
        $log = new Log('error.log');
        if ($this->post['accountmanagername'] != NULL && $this->post['accountmanagerid'] != NULL && $this->post['accountmanagerid'] > 0 && $this->model_account_customer->getTotalAccountManagersByNameAndId($this->request->post['accountmanagername'], $this->request->post['accountmanagerid']) == 0) {
