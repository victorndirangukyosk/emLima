...
$_['heading_title_sub_user'] = 'Your order approval pending!';

// Text
$_['text_basket'] = 'Shopping Cart';
$_['text_checkout'] = 'Checkout';
$_['text_success'] = 'Success';
$_['text_customer_sub_user'] = '<p>Your order approval pending!</p><p>Please contact your super user!</p><p>You can view your order status by clicking on <a href="%s" style="color:#43b02b;">My Orders</a> under <a href="%s"  style="color:#43b02b;">My Account</a>.</p><p>Thanks for shopping with us!</p>';
