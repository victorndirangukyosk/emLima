<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="sign-up-form">
    <div class="row">
        ...
        <div id="other_signup_div">
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input id="First Name" name="firstname" type="text" placeholder="<?= $entry_firstname ?>" class="form-control input-md" required="">
                </div>
            </div>
            <div class="form-group">
                <label class="col-md-12 control-label sr-only" for="Name"><?= $entry_lastname ?></label>
                <div class="col-md-12">
                    <input id="Last Name" name="lastname" type="text" placeholder="<?= $entry_lastname ?>" class="form-control input-md" required="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12">
                    <input id="email" name="email" type="text" placeholder="<?= $entry_email_address ?>" class="form-control input-md" required="">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-12 input-group" style="padding-right: 15px;padding-left: 15px;">
                    ...
                    <input id="register_phone_number" name="telephone" type="text" class="form-control input-md" required="" placeholder="<?= $entry_phone?>" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 &amp;&amp; event.charCode <= 57" minlength="9" maxlength="9">
        ...
        <div class="form-group">
            ...
            <div class="col-md-12">
                <button id="signup" type="button" class="btn btn-default btn-block btn-lg">
