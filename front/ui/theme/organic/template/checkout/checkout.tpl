                    ...
                    <div id="accordion" class="checkout">
                        <div class="panel checkout-step">
                            ...
                            <?php if($loggedin) { ?>
                                ...
                                <div> <span class="checkout-step-number">1</span>
                                    <h4 class="checkout-step-title"> <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" > </a> <?= $loginform ?> 

                                    </h4>
                                    <a id='checkoutLogout' type='button' class='btn btn-primary checkoutLogoutButton'> Logout </a>
                                </div>  
                            ...
                            <?php } else { ?>
                                ...
                                <div id="collapseOne" class="collapse in">
                                    <div class="checkout-step-body">
                                        <div class="mydivs">
                                            <div class="row">
                                                <a href="#" type="button" class="btn btn-primary col-sm-2" type="button" data-toggle="modal" data-target="#phoneModal"><?= $text_sign_in ?></a>

                                                <p style="font-size: 23px;margin-left: 15px;" class="col-sm-2"> <?= $text_or?></p>

                                                <a href="#" type="button" class="btn btn-primary col-sm-4" type="button" data-toggle="modal" data-target="#signupModal-popup"><?= $text_register ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel checkout-step">
                            <div role="tab" id="headingTwo"> <span class="checkout-step-number">2</span>
                                ...
                                <?php if($loggedin) { ?>
                                    <a type="button" class="btn btn-primary collapsed checkoutChangeButton" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" style="display: none;max-height: 32px;"> Change </a> 
                                <?php } ?>
                        ...
                        <div class="panel checkout-step">
                            <div role="tab" id="headingDeliveryOptions"> <span class="checkout-step-number">3</span>
                        ...
                        <div class="panel checkout-step">
                            <div role="tab" id="headingThree"> <span class="checkout-step-number">4</span>
                            ...
                            <div id="collapseThree" class="panel-collapse collapse">
                                <div class="checkout-step-body">
                                    ...
                                    <!-- <a class="collapsed btn btn-grey" disabled="disabled" role="button" data-toggle="collapse" data-parent="#accordion" href="#" id="payment-next">  <?= $text_next?>  </a>
                        ...
                        <?php if($checkout_question_enabled){ ?>
                            <div class="panel checkout-step">
                                <div role="tab" id="headingQuestion"> <span class="checkout-step-number">5</span>
                        ...
                        <div class="panel checkout-step">
                            ...
                            <?php if($checkout_question_enabled) { ?>
                                <div role="tab" id="headingFour"> <span class="checkout-step-number">6</span>
                            <?php } else { ?>
                                <div role="tab" id="headingFour"> <span class="checkout-step-number">5</span>
                            <?php } ?>
                ...
                <div class="col-md-4">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?php } ?>
                            <div class="checkout-promocode-form">
                                <form class="dropoff-form">
                                    <div class="form-group">
                                        <!-- <input type="text" name="dropoff_notes" class="form-control" placeholder="<?= $text_dropoff_notes?>" id="dropoff_notes"> -->
                                        <textarea name="dropoff_notes" class="form-control" maxlength="200" placeholder="<?= $text_dropoff_notes?>" id="dropoff_notes" style="height: 100px;font-size: 17px;"></textarea>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div class="checkout-sidebar-merchant-box">
                                <div class="checkout-cart-merchant-box"> <span class="checkout-cart-merchant-name"><?= $store_name?></span> <span class="checkout-cart-merchant-item"><?= $total_quantity ?> <?= $text_item ?></span> </div>
                                <div class="checkout-cart-products">
                                    <div class="collapse" id="collapseExample">
                                        <div class="checkout-item-list">
                                            <!-- <div class="checkout-charges">
                                                <div class="checout-charges-title"><?= $text_deliver_charges?></div>
                                                <div class="checout-charges-price charges-free"><?= $text_free ?></div>
                                            </div> -->

                                            <?php $i = 1; foreach ($products_details as $product) { ?>
                                    ...
                                    <div class="checkout-viewmore-btn"> <a class="btn-link" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" ><?= $text_view ?> <?= $total_quantity ?> <?= $text_item ?></a> </div>
                                ...
                                <form id="new-address-form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input id="name" name="modal_address_name" type="text"  value="<?= $name ?>" class="form-control input-md" required="">
                                        </div>
                                    </div>
                                    
                                    <!-- Text input-->
                                    <!-- <div class="form-group">
                                        <label class="col-md-12 control-label" for="street"><?= $text_stree_society_office?></label>
                                        <div class="col-md-12">
                                            <input id="street" name="modal_address_street" type="text"  class="form-control input-md" required="">
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="flat" name="modal_address_flat" type="text"  class="form-control input-md" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <!-- <div class="col-md-12">
                                            <input id="Locality" name="modal_address_locality" type="text" class="form-control input-md" required="">
                                        </div> -->
...
function loadConfirm() {
    ...
    saveOrder();
   /*$.ajax({
        url: 'index.php?path=checkout/confirm/index',
        type: 'post',
        dataType: 'html',
        cache: false,
        beforeSend: function() {
            $('#pay-confirm-order').html('<div class="text-center"><i class="fa fa-spinner fa-spin checkout-spin"></i></div>');
        },
        success: function(html) {
            $('#pay-confirm-order').html(html);
        },
        error: function(xhr, ajaxOptions, thrownError) {
            alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
        }
...
function saveOrder() {
    ...
    if(!$error) {
        if($('input[id="shipping_method"]').val() == 'express.express') {
            console.log("express escaped check");
            $('input[name="shipping_time_selected"]').val('');
            $('input[name="dates_selected"]').val('');
        } else {

            console.log("normal not escaped check");
            var shipping_time_selected = $('input[name="shipping_time_selected"]').val();
            if (shipping_time_selected.length <= 0) {
                console.log("time selected");
                $error = true;
            }

            var shipping_time_selected = $('input[name="dates_selected"]').val();
            if (shipping_time_selected.length <= 0) {
    ...
    var sendData = $('#place-order-form').serialize() + '&dropoff_notes=' + dropoff_notes;
    console.log('sendData');
    console.log(sendData);
    if (!$error) {
...
$(document).delegate('#dates_selected', 'click', function() {
    ...
    console.log("dates_selected id selected"+$(this).attr('data-value'));
});
$(document).delegate('#time_selected', 'click', function() {
    ...
    $('input[name="shipping_time_selected"]').val($(this).attr('data-value'));
    $('input[name="dates_selected"]').val($(this).attr('data-date'));
...
jQuery(function($) {
   ...
   $("#fax-number").mask("<?= $taxnumber_mask_number ?>",{autoclear:false,placeholder:"<?= $taxnumber_mask ?>"});
    ...
    $(document).delegate('#timeslot-next', 'click', function() {
        console.log("timeslot-next clickxx");
        var error = false;
        ...
        <?php foreach ($store_data as $os):  ?>
            ...
            console.log(shipping_method);
            console.log("shipping_methodxx");
            if (shipping_method == undefined || shipping_method.length <= 0) {
                console.log("shipping_method selectesdxx");
             error = true;
            }
        <?php endforeach; ?>
        ...
        <?php foreach ($store_data as $os):  ?>
            ...
            if($('#delivery-time-wrapper-<?php echo $os["store_id"] ?> ul.list-group').length) {
                if($('#delivery-time-wrapper-<?php echo $os["store_id"] ?> ul.list-group input[type=radio]:checked').val() == undefined ) {
                    $error = true;
                    console.log("timeslot not selected");
                }    
            } else {
                // shipping is express
            }
    ...
    $(document.body).on('change', '.LocalityId', function(e) {
        console.log('change LocalityId checkout page');
