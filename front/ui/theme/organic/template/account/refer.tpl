                                                    ...
                                                    <form action="<?= $refer ?>" method="post"  enctype="multipart/form-data" class="form-horizontal">
                                                        <div class="col-lg-12 col-sm-12 col-xs-6">
                                                            ...
                                                            <div >
                                                                ...
                                                                <div class="col-sm-8" style="color: green; text-align:left">
                                                                    
                                                                    <?php if($referral_data['referrer']) { ?>
                                                                        <div>*<?=$referral_data['referrer'] ?></div>
                                                                    <?php } ?>

                                                                    <?php if($referral_data['referred']) { ?>
                                                                        <div>*<?=$referral_data['referred'] ?></div>
                                                                    <?php } ?> 
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-action">
                                                                    <input type="submit" class="btn btn-lg btn-primary ladda-button pull-right" id="sendmail" name="sendmail" value="<?= $entry_send_mail ?>">                                    
                                                                </div>
                                                            </div>
