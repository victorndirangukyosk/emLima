<?php echo $header; ?>
                            ...
                            <div class="col-md-9 nopl">
                                <div class="dashboard-address-content">
                                    ...
                                    <div class="col-md-12"><a href="#" type="button" class="btn-link" data-toggle="modal" data-target="#addressModal"><i class="fa fa-plus-circle"></i> <?= $text_add_new_address?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <form id="new-address-form">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <button type="button" class="btn btn-grey test" data-dismiss="modal"><?= $text_close?></button>
                                        </div>
                                    </div>
