                ...
                <div class="fl-nav-links">
                  ...
                  <ul class="links">
                     ...
                     <?php if($is_login) { ?>
                            ...
                            <?php if(isset($label_my_address) && isset($address)){?>
                            <li><a href="<?= $address ?>" ><i class="fa fa-address-book"></i><?= $label_my_address ?></a></li>
                            <?php }else{ ?>
                              <li><a href="<?php echo $base?>address" ><i class="fa fa-address-book"></i>My Address</a></li>
                            <?php } ?>
                            <?php if($this->config->get('config_credit_enabled')) { ?>
                               <?php if(isset($credit) && isset($text_my_cash)){?>
                                <li><a href="<?= $credit ?>" ><i class="fa fa-money"></i><?= $text_my_cash ?></a></li>
                              <?php }else{ ?>
                              <li><a href="<?php echo $base?>credit" ><i class="fa fa-address-book"></i>My Wallet</a></li>
                            <?php } ?>
                            <?php } ?>
