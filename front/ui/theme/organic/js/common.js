jQuery(document).ready(function() {
    /*jQuery('.store-cart-action.header-item').click(function(){jQuery('html,body').animate({ scrollTop: 650 }, 'slow')})
    jQuery('.fl-nav-links').click(function(){jQuery('html,body').animate({ scrollTop: 650 }, 'slow')})
    jQuery('.detail-bnt').click(function(){jQuery('html,body').animate({ scrollTop: 650 }, 'slow')});
    */
    "use strict";
    /*  Menu */
    slideEffectAjax()
