                    ...
                    <div class="table-responsive shopping-cart-tbl  container">
                        ...
                        <fieldset>
                            <table id="shopping-cart-table" class="data-table cart-table table-striped">
                                ...
                                <div>
                                    <div class="checkout-cart-merchant-box text-center">
                                        <span><h1>Order Summary</h1></span> <span
                                                class="checkout-cart-merchant-item"></span></div>
                                    <div>
                                                ...
                                                <span class="price font-bold"><?= $product['unit'] ?></span>                
                                                    ...
                                                    <td class="a-right movewishlist">
                                                        <input disabled type="number" name="cart[<?= $i ?>][qty]"
                                                               id="cart[<?= $i ?>][qty]"
                                                               value="<?= $product['quantity']?>" size="4" title="Qty"
                                    ...
                                    <td colspan="9" class="a-right last">
                                        <a href="<?php echo $continue; ?>">
                                            <button type="button" title="Continue Shopping" class="button btn-continue"
                                                    style="width:210px;background-color: #ec9f4e ; padding: 15px 20px 27px 20px;">
                                        ...
                                        <button type="submit"
                                                ...
                                                class="button btn-update"><span id="updatecart">Update Cart</span>
                                        </button>
                                        ...
                                        <button type="submit"
                                                ...
                                                class="button btn-empty" id="empty_cart_button"><span id="clearcart"
                                                                                                      class="cart-header_items-count clear-cart"
                                                                                                      style="border-bottom:none;"
                                                                                                      data-confirm="This will empty your cart!!">Clear Cart</span>
                                        </button>
                                    </td>
                                </tr>
                                </tfoot>
                            ...
                            <form id="new-address-form">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                            ...
                                                            <button id="locateme" class="btn btn-default disabled"
                                                                    ...
                                                                    onclick="openGMap()" data-target="#GMapPopup"><i
                                                                        class="fa-crosshairs fa"></i> <?= $locate_me ?> </button>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="modal_address_locality" id="Locality" type="text"
                                               style="background-color:#DEDEDE;" readonly
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-btn">
                                        ...
                                        <button class="btn btn-default" id="detect_location"
                                                ...
                                                type="button" onclick="getLocation()"><i
                                                    class="fa fa-location-arrow"></i> <?= $detect_location ?></button>
...
<script type="text/javascript">
    ...
    :
            ?
    >
        var shipping_method = $('input[name=\'shipping_method-' + < ? php echo
        $os['store_id'] ?
    >
        +'\']:checked'
    ).
        ...
        appendDataToSend += '&dropoff_notes[' + < ? php echo
        $os['store_id'] ?
    >
        +']=' + note;
...
<script type="text/javascript">
    ...
    :
            ?
    >
        var questionRes = $('input[name=\'question-' + < ? php echo
        $question['checkout_question_id'] ?
    >
        +'\']'
    ).
        is(':checked');
