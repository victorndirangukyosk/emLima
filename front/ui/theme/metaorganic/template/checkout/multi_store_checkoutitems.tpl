    ...
    <div>
                    ...
                    <div class="table-responsive shopping-cart-tbl  container">
                        ...
                        <fieldset>
                            <table id="shopping-cart-table" class="data-table cart-table table-striped">
                                ...
                                <div>
                                    <div class="checkout-cart-merchant-box text-center"> <span>
                                            <h1>Order Summary</h1>
                                        </span> <span class="checkout-cart-merchant-item"></span> </div>
                                        ...
                                        <div class="collapse in" id="collapseExample<?= $key ?>">
                                            <div class="checkout-item-list">
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td class="image hidden-table"><img src="<?= $product['thumb'] ?>"
                                                            width="75" alt=""></td>
       ...
       $fpt.=' '.  $pt['type'].'-'.$pt['value'] ;
         ...
         ?><?= $fpt?></div>
                                                        ...
                                                        <div style="font-size:13px;">( <?= $product['product_note']?> )
                                                        </div>
                                                        <?php } ?>
                                                    </td>
     ...
     <span style="font-size:13px;"><?= $product['product_note']?></span> 
                                                    ...
                                                    <td class="a-right hidden-table" style="width:150px">
                                                        <span class="cart-price">
                                                            <span style="font-size:13px;"
                                                                class="font-bold"><?= $product['unit'] ?></span>
                                                        </span>


                                                    </td>
                                                    <td class="a-right movewishlist">
                                                        <input disabled type="number" name="cart[<?= $i ?>][qty]"
                                                            id="cart[<?= $i ?>][qty]" value="<?= $product['quantity']?>"
                                                            size="4" title="Qty" class="input-text qty" maxlength="12"
                                                            style="width:80px !important;disabled">
                                                    </td>
                                                    <td class="a-right hidden-table">
                                                        <span class="cart-price">

                                                            <span class="price font-bold"
                                                                id="spancart[<?= $i ?>][qty]"><?php echo $product['total']; ?></span>
                                                        </span>
                                                    </td>
                                                    <td class="a-center hidden-table">
                                                        <stop> <a class="edit-bnt"
                                                    ...
                                                    <td class="a-center hidden-table a">
                                                        <a id="update_quantity" class="fa fa-refresh"
                                                            title="Update product quantity"
                                                            data-id="<?= $product['key']?>"
                                                            data-prodorderid="<?= $i?>"><span
                                                                data-id="<?= $product['key']?>"></span></a>
                                                    </td>
                                                    <td class="a-center hidden-table">
                                                        <p> <a title="Remove item" class="button remove-item"
                                                                style="background-color: #ec9f4e ;"><span><span><?= $product['key']?></span></span></a>
                                                        </p>
                                                    </td>
                                ...
                                <tfoot>
                                    <tr class="first last">
                                        <td colspan="12" class="a-right last">
                                            <a href="<?php echo $continue; ?>"> <button type="button"
                                                    title="Continue Shopping" class="button btn-continue"
                                                    style="width:210px;background-color: #ec9f4e ; padding: 15px 20px 27px 20px;"><span><span>Continue
                                                            Shopping</span></span></button></a>


                                            <button type="submit"
                                                style="width:170px;background-color: #ec9f4e ; padding: 15px 20px 27px 20px;"
                                                name="save_basket_action" id="save_basket_action" value="save_basket"
                                                title="Save Basket" class="button btn-update"
                                                data-confirm="This will add products to basket!!"><span
                                                    id="savebasket">Save Basket</span></button>
                                            <button type="submit"
                                                style="width:170px;background-color: #ec9f4e ; padding: 15px 20px 27px 20px;"
                                                name="update_cart_action" value="update_qty" title="Update Cart"
                                                class="button btn-update"><span id="updatecart">Update
                                                    Cart</span></button>

                                            <button type="submit"
                                                style="width:180px;background-color: #ec9f4e ; padding: 15px 20px 27px 20px;"
                                                name="update_cart_action" value="empty_cart" title="Clear Cart"
                                                class="button btn-empty" id="empty_cart_button"><span id="clearcart"
                                                    class="cart-header_items-count clear-cart1"
                                                    style="border-bottom:none;"
                                                    data-confirm="This will empty your cart!!">Clear
                                                    Cart</span></button>
                                        </td>
                                    </tr>
                                </tfoot>
                        ...
                        <ul class="form-list">
                            ...
                            <li>
                                ...
                                <div class="checkout-promocode-form">
                                    ...
                                    <textarea name="dropoff_notes" class="form-control" maxlength="200"
                                        placeholder="<?= $text_dropoff_notes?>" id="dropoff_notes"
                                        style="height: 100px;">
                                    </textarea>
            ...
            <div class="discount">
                ...
                <form id="discount-coupon-form" action="" method="post" class="promo-form">
                    ...
                    <button type="button" title="Apply Coupon" class="button coupon "
                        style="width:180px;background-color: #ec9f4e;align:center;margin-top:20px; padding:20px 0px 27px 0px"
                        id="promo-form-button" value="Apply Coupon"><span>Apply Coupon</span></button>
                            ...
                            <div class="checkout-promocode-form">
                                <div class="form-group">
                                    <span class="input-group-btn" onclick="setOrderNotes()">
                                        <a id="button-reward"
                                            href="<?php echo $continue.'/index.php?path=checkout/checkout'; ?>"
                                            class="btn btn-primary btnsetall" style="width: 100%;height: 100%;"
                                            type="button">Proceed to Check out
                                        </a>
                                    </span>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="addnews-address-form">
                            ...
                            <form id="new-address-form">
                                ...
                                <input type="hidden" value="<?php echo $city_id; ?>" name="shipping_city_id"
                                    id="shipping_city_id">
                                <input type="hidden" value="<?php echo $zipcode; ?>" name="shipping_zipcode"
                                    id="shipping_zipcode">
                                    ...
                                    <div class="col-md-12">
                                        <div class="select-locations">
                                            <label class="control control--radio"><?= $text_home_address?>
                                                <input type="radio" name="modal_address_type" value="home"
                                                    checked="checked" />
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <input id="name" name="modal_address_name" type="text" placeholder="Name"
                                            value="<?= $name ?>" class="form-control input-md" required="">
                                    </div>
                                </div>
                                <!-- Text input-->
                                <div class="form-group">
                                    <label class="col-md-12 control-label"
                                        for="flat"><?= $text_flat_house_office?></label>
                                    <div class="col-md-12">
                                        <input id="flat" name="modal_address_flat" type="text"
                                            placeholder="45, Sunshine Apartments" class="form-control input-md"
                                            required="">
                                    </div>
                                </div>


                                <input id="street" name="modal_address_street" type="hidden"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-group">
                                            ...
                                            <input id="Locality" name="modal_address_locality" type="text"
                                                placeholder="<?= $text_flat_house_office?>"
                                                class="form-control input-md LocalityId" required="">
                                            <span class="input-group-btn">

                                                <button id="locateme" class="btn btn-default disabled"
                                                    style="color: #333;background-color: #fff;border-color: #ccc;line-height: 2.438571; "
                                                    type="button" data-toggle="modal" onclick="openGMap()"
                                                    data-target="#GMapPopup"><i class="fa-crosshairs fa"></i>
                                                    <?= $locate_me ?> </button>
                                    ...
                                    <?php } else { ?>
                                    <div class="col-md-12">
                                        <input name="modal_address_locality" id="Locality" type="text"
                                            class="form-control input-md LocalityId" required="">
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="modal_address_locality" id="Locality" type="text"
                                            style="background-color:#DEDEDE;" readonly value="<?= $address_locality ?>"
                                            class="form-control input-md LocalityId pac-target-input" required="">
                                        <?php }else{ ?>
                                        <input name="modal_address_locality" id="Locality" type="text"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="shipping_zipcode" type="text" value="<?php echo $zipcode; ?>"
                                            name="shipping_zipcode" class="form-control input-md" disabled="true">
                                    </div>
                                </div>
                                <?php } else { ?>
                                <input id="shipping_zipcode" type="hidden" value="<?php echo $zipcode; ?>"
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <button id="singlebutton" name="singlebutton" type="button"
                                            class="btn btn-primary btnsetall"
                                            onclick="saveInAddressBook()"><?= $text_save?></button>
                                        <button type="button" class="btn btn-grey"
                                            data-dismiss="modal"><?= $text_close?></button>
                                    </div>
                                </div>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div id="wrapper">
                        ...
                        <div id="over_map">
                            ...
                            <div class="input-group">
                                ...
                                <input name="modal_address_locality" type="text" id="gmap-input"
                                    class="form-control input-md LocalityId LocalityId2" required="">
                                <span class="input-group-btn">

                                    <button class="btn btn-default" id="detect_location"
                                        style="color: #333;background-color: #fff;border-color: #ccc;width: 150px;line-height: 2.438571; "
                                        type="button" onclick="getLocation()"><i class="fa fa-location-arrow"></i>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <center>
                            <button id="saveLatLng" type="button" class="btn btn btn-primary btnsetall"
                                onclick="saveLatLng()"><?= $text_ok?></button>
                        </center>
                    </div>
                </div>
            </div>
...
<script type="text/javascript"
    src="<?= $base?>admin/ui/javascript/map-picker/js/locationpicker.jquery.js?v=2.3"></script>
