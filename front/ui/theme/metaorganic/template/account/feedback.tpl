...
<script src="<?= $base; ?>front/ui/theme/metaorganic/assets_landing_page/js/iziToast.min.js" async
 ...
 <div class="v28_1">
   <div class="v28_2"></div>
    <div class="v28_4"><span>Let us know your feedback</span></div>
    ...
    <div class="v34_63">
     ...
     <div class="emoji-container">
        <svg width="32" height="32" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                class="emoji"  id="emoji1" onclick="getRating(1)"
...
<path d="M20 2H4C3.46957 2 2.96086 2.21071 2.58579 2.58579C2.21071 2.96086 2 3.46957 2 4V22L6 18H20C20.5304 18 21.0391 17.7893 21.4142 17.4142C21.7893 17.0391 22 16.5304 22 16V4C22 3.46957 21.7893 2.96086 21.4142 2.58579C21.0391 2.21071 20.5304 2 20 2ZM8 14H6V12H8V14ZM8 11H6V9H8V11ZM8 8H6V6H8V8ZM15 14H10V12H15V14ZM18 11H10V9H18V11ZM18 8H10V6H18V8Z" fill="#A493FD" style=""/>
</svg>
      ...
      <path d="M13.5 14H11.5V9H13.5V14ZM13.5 18H11.5V16H13.5V18ZM1.5 21H23.5L12.5 2L1.5 21Z" fill="#FF900D"/>
      </svg>
      </div>
      </div>  
