              ...
              <fieldset>
                ...
                <span class="input-group-btn">
                   ...
                   <!-- <p id="button-reward" class="phonesetbut" >
                    ...
                    <input type="tel" name="telephone" id="tel" value=""  id="input-telephone" class="form-control input-lg" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 &amp;&amp; event.charCode <= 57" minlength="9" maxlength="9" />
