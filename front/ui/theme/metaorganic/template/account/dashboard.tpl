...
<div id="content">
  <div class="page-header">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-4">
          <div id="reportrange" style="height:35px;background: #fff; cursor: pointer; padding: 0px 10px; border: 1px solid #ccc; font-weight: normal;margin-right:20px;">
  ...
  <div class="container">
    <div class="row" id="sum_widgets" style="margin: 5rem 0rem;">
      <div class="col-md-4">
        <div class="text-center">
          ...
          <div class="profile-number" ><a  href="index.php?path=account/dashboard/customerStatement&pdf=1"  data-toggle="tooltip" title="Statement"
      ...
      <div class="col-md-4">
        <div class="panel profit db mbm">
          <div class="panel-body">
            ...
            <h4 class="value" style="color: unset"><span
                id="total_orders"><?php echo $DashboardData['total_orders']; ?></span></h4>
        ...
        <div class="panel profit db mbm">
          <div class="panel-body">
            ...
            <h4 class="value" style="color: unset"><span
                id="avg_value"><?php echo $DashboardData['avg_value']; ?></span></h4>
      ...
      <div class="col-md-4">
        <div class="panel db mbm">
          <div class="panel-body">
            ...
            <h4 class="value" style="color: unset"><span
                id="total_spent"><?php echo $DashboardData['total_spent']; ?></span></h4>
                ...
                <table class="table table-bordered" id="most">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="#" onclick="getPurchaseHistory(<?= $_bestseller['product_id'] ?>)" data-toggle="modal"
              ...
              <form id="productHistory-form" action="" method="post" enctype="multipart/form-data">
                <div class="form-row">
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <input id="timespurchased" maxlength="30" required style="max-width:100% ;" name="timespurchased"
                  ...
                  <div class="form-row">
                    <div class="form-group">
                      ...
                      <div class="col-md-12">
                        <input id="qunatitypurchased" maxlength="30" required style="max-width:100% ;"
                          name="qunatitypurchased" type="text" class="form-control input-md" readonly>
                        <br/> </div>
                    </div>
                    ...
                    <div class="form-row">
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input id="totalvalue" maxlength="30" required style="max-width:100% ;" name="totalvalue"
                            type="text" class="form-control input-md" readonly>
                          <br /> </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-12">
                          <button type="button" class="btn btn-grey" data-dismiss="modal"
                            style="width:30%;background-Color:green; float: right; margin-top: 10px; height: 45px;border-radius:20px">Close</button>
                        </div>
                      </div>
                    </div>
              </form>
...
<link href="admin/ui/javascript/jquery/datetimepicker/bootstrap-datetimepicker.min.css" type="text/css" rel="stylesheet"
  media="screen" />
