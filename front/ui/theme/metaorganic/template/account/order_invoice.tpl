...
<head>
    ...
    <link rel="stylesheet" href="admin/ui/stylesheet/bootstrap.min.css">
    <link rel="stylesheet" href="admin/ui/javascript/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="admin/ui/stylesheet/print.css">
</head>
