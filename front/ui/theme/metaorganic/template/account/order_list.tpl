            ...
            <div class="order-details">
                ...
                <div class="list-group my-order-group">
                    <li class="list-group-item my-order-list-headnew">
                        <div class="row"><div class="col-md-2"><strong>#<?php echo $order['order_id']; ?></strong></div><div class="col-md-4">Store Name: <span><?php echo $order['store_name']; ?></div><div class="col-md-6">Order Date: <span><?php echo $order['date_added']; ?>, <?php echo $order['time_added']; ?></div></div>
