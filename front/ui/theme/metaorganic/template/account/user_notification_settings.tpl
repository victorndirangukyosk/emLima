                    ...
                    <table id="employee" class="table table-bordered">
                        ...
                        <tbody id="emp_body">
                            <tr>
                                ...
                                <td><?php if($customer_info['sms_notification'] == 0) { ?><a data-confirm="Enable Sms Notification!" class="btn btn-success useractivate" data-active="1" data-notification-id="sms" data-store-id="<?php echo $customer_info['customer_id']; ?>" data-toggle="tooltip" title="Activate Sms Notification"><i class="fa fa-check"></i></a><?php } ?>
                                <?php if($customer_info['sms_notification'] == 1) { ?><a data-confirm="Disable Sms Notification!" class="btn btn-success useractivate" data-active="0" data-notification-id="sms" data-store-id="<?php echo $customer_info['customer_id']; ?>" data-toggle="tooltip" title="De Activate Sms Notification"><i class="fa fa-times"></i></a><?php } ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><?php if($customer_info['mobile_notification'] == 0) { ?><a data-confirm="Enable Mobile Notification!" class="btn btn-success useractivate" data-notification-id="mobile" data-active="1" data-store-id="<?php echo $customer_info['customer_id']; ?>" data-toggle="tooltip" title="Activate Mobile Notification"><i class="fa fa-check"></i></a><?php } ?>
                                <?php if($customer_info['mobile_notification'] == 1) { ?><a data-confirm="Disable Mobile Notification!" class="btn btn-success useractivate" data-notification-id="mobile" data-active="0" data-store-id="<?php echo $customer_info['customer_id']; ?>" data-toggle="tooltip" title="De Activate Mobile Notification"><i class="fa fa-times"></i></a><?php } ?>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><?php if($customer_info['email_notification'] == 0) { ?><a data-confirm="Enable Email Notification!" class="btn btn-success useractivate" data-notification-id="email" data-active="1" data-store-id="<?php echo $customer_info['customer_id']; ?>" data-toggle="tooltip" title="Activate Email Notification"><i class="fa fa-check"></i></a><?php } ?>
                                <?php if($customer_info['email_notification'] == 1) { ?><a data-confirm="Disable Email Notification!" class="btn btn-success useractivate" data-notification-id="email" data-active="0" data-store-id="<?php echo $customer_info['customer_id']; ?>" data-toggle="tooltip" title="De Email Notification"><i class="fa fa-times"></i></a><?php } ?>
                                </td>
                            </tr>
                        </tbody>
                    </table>
