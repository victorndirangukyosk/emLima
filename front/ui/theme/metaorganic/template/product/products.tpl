 ...
 <a class="product-detail-bnt open-popup" role="button" data-store="<?= $product['store_id'] ?>" data-id="<?= $product['product_store_id'] ?>" target="_blank"  aria-label="<?=$product['name']?>">
                                      ...
                                      <!--  <section class="_1SQpT">
                                        ...
                                        <div class="vfsyA col-md-12 col-sm-12 pl0">
                                                    ...
                                                    <div>
                                                    <del><?= $product['variations'][0]['special'];?></del>(<?= $product['variations'][0]['discount_percentage'];?>% OFF)
                                                    </div>
                                                    <?php } ?>
                                                    
                                                    <?php if($product['variations'][0]['discount_percentage'] > 0) { ?>
                                                    <div style="color:#6dbd46">
                                                     <?= $product['variations'][0]['discount_price'];?>    <?php  echo '/ ' .'Per'./*. $product['variations'][0]['weight'] .*/ ' ' . $product['variations'][0]['unit']; ?>
                                                     </div>
                                                     <?php } ?>
