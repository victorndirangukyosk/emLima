                  ...
                  <div class="col d-flex flex-row">
                     <div class="top_bar_contact_item">
                        <div class="top_bar_icon"><img
                              src="<?= $base ?>front/ui/theme/metaorganic/assets/images/icons/phone.svg"
                              alt="Phone Icon"></div>
                        +254 738 770 186
                     </div>
                     <div class="top_bar_contact_item">
                        <div class="top_bar_icon"><img
                              src="<?= $base ?>front/ui/theme/metaorganic/assets/images/icons/mail.svg" alt="Mail Icon">
                        </div><a href="mailto:hello@kwikbasket.com">hello@kwikbasket.com</a>
                     </div>
                     <div class="top_bar_content ml-auto">
                        <div class="top_bar_user">
                           <div class="user_icon"><img
                                 src="<?= $base ?>front/ui/theme/metaorganic/assets/images/icons/user.svg"
                                 alt="User icon"></div>
                           <div>Hi,
                              <?= $full_name ?>
                           </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-2 col-sm-3 col-3 order-1">
                     <div class="logo_container">
                        <div class="logo">
                           <a href="<?= $base ?>">
                              <img src="<?= $base ?>front/ui/theme/metaorganic/assets/images/logo.svg"
                                 alt="KwikBasket Logo">
                           </a>
                        </div>
                     </div>
                     ...
                     <div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
                        <div class="wishlist d-flex flex-row align-items-center justify-content-end">
                           <div class="wishlist_icon"><img
                                 src="<?= $base;?>front/ui/theme/metaorganic/assets/images/icons/heart.png" alt="">
                           </div>
