...
<body data-wrapper-optimized="" id="homenew" class="new-homepage-image-format drawer drawer--top">
                    ...
                    <div id="search-form-wrapper" class="header__search-bar search-form-wrapper">
                        ...
                        <form id="search-form-form"
                            ...
                            <ul class="header__search-bar-list header__search-bar-item--before-keyword-field">
                                ...
                                <li
                                    class="header__search-bar-item header__search-bar-item--location search-location-all">
                            ...
                            <ul class="header__upper-deck-list">
                                ...
                                <li class="header__upper-deck-item header__upper-deck-item--register">
                                    <a data-toggle="modal" data-dismiss="modal" data-target="#signupModal-popup"
                                        class="header__upper-deck-item-link register"
                                ...
                                <li class="header__upper-deck-item header__upper-deck-item--signin">
                                    <a data-toggle="modal" data-target="#phoneModal"
                                        class="header__upper-deck-item-link sign-in"
                                        data-spinner-btn="{showOnSubmit: false}">
                                        Sign In</a>
                                </li>
                                <li class="header__upper-deck-item header__upper-deck-item setcartbtn">
                                    <div class="butn setui"> <button class="btn btn-default mini-cart-button"
                                            role="button" data-toggle="modal" data-target="#store-cart-side"
                                            id="mini-cart-button">
                                ...
                                <div>
                                    <div class="menuset">
                                        <div class="newset" style="margin-top: 20px;"><a class="btn"
                                                href="<?= $dashboard ?>"> <span><?= $full_name ?></span> </a>

                                            <div class="dropdownset" style="display:none;">
                                                <div class="dropdownsetnew" style="margin-top: 10px;"><a
                                                        class="header__upper-deck-item-link" href="<?= $dashboard ?>"><i
                                                            class="fa fa-user"></i>Dashboard &nbsp;<span
                                                            class="badge badge-pill badge-light">New</span></a></div>
                                                <div class="dropdownsetnew"><a class="header__upper-deck-item-link"
                                                        href="<?= $account ?>"><i class="fa fa-user"></i>My Account</a>
                                                </div>
                                                <div class="dropdownsetnew"><a class="header__upper-deck-item-link"
                                                        href="<?= $help ?>"><i
                        ...
                        <div class="dropdownsetnew"><a class="header__upper-deck-item-link" href="#"
                         ...
                         -->
                                        ...
                                        <div class="butn setui" style="position:relative; z-index:-1000;">
                                            <div class="btn btn-default mini-cart-button" role="button"
                          ...
                          currency->format($this->cart->getTotal()); ?></span>
                                                ...
                                                <span class="badge cart-count"
                                                    style="margin: 4px 0px;"><?= $this->cart->countProducts(); ?> items
                                                    in cart</span>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="container--full-width featured-categories <?php echo ($i==1) ? "first-feature-cat": "" ?>">
        <div class="container" style="width:100%;">
                    ...
                    <li class="col-md-2 ">
                        ...
                        <div class="_2sT86 _1fLGj">
                            <a class="product-detail-bnt open-popup" role="button" data-store=<?= ACTIVE_STORE_ID?>
                                data-id="<?= $product['product_store_id'] ?>" target="_blank"
                                        ...
                                        <section class="_25Upe">
                                            <section class="inner_sec">
                                                ...
                                                <div class="_3XNMI">
                                                    <div class="_2_3rp">
                                                        <div style="">
                                                            <img class="_1xvs1" src="<?=$product['thumb']?>"
                                                                title="<?=$product['name']?>"
                    ...
                    <div id="product_<?=$product['product_id']?>" class="modal fade" role="dialog">
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body class=" col-lg-2 col-md-4 col-sm-6 col-xs-6 nopadding
                                    product-details" style="border-right: 1px solid rgb(215, 220, 214);">
                                    <div>

                                        <?php /*echo "<pre>";print_r($product);die;*/ if(isset($product['percent_off']) && $product['percent_off'] != '0.00') { ?>

                                        <span class="spacial-offer">
                                            <?php echo $product['percent_off'].'% OFF';?></span>
                                        <?php } ?>
                                        ...
                                        <a href="#"
                                            ...
                                            id="list-btn" data-id="<?= $product['product_id'] ?>" type="button"
                                            data-toggle="modal" data-target="#listModal"><img class="add-list-png"
                                                src="<?= $base;?>front/ui/theme/mvgv2/images/list-icon.png">
                                        </a>

                                        <?php } else { ?>
                                        <a href="#" class="add-to-list" type="button" data-toggle="modal"
                                            data-target="#phoneModal"><img class="add-list-png"
                                                src="<?= $base;?>front/ui/theme/mvgv2/images/list-icon.png"></a>
                                    ...
                                    <div class="product-block" data-id="<?= $product['product_store_id'] ?>">
                                        ...
                                        <div class="product-description" data-id="<?= $product['product_store_id'] ?>">
                                            ...
                                            <p class="product-info open-popup"
                                                data-id="<?= $product['product_store_id'] ?>"><span
                                            ...
                                            <div class="product-price">
                                                ...
                                                <span class="price-cancelled open-popup"
                                                    data-id="<?= $product['product_store_id'] ?>" style="display: none"
                                                    ;>
                                                </span>
                                                <span class="price open-popup"
                                                    data-id="<?= $product['product_store_id'] ?>">
            ...
            <span class="view-all-button"><a
                    href="<?=$this->url->link('product/store', 'store_id='.ACTIVE_STORE_ID).'?cat='.$page_link?>">View
                    All <?=$category['name']?></a></span>
        </div>
    ...
    <div class="tabbed__tab-content homepage-gallery__tab-alerts" data-tabbed-role="tab"
        data-tab-content-name="Westlands" style="display:none;"></div>
