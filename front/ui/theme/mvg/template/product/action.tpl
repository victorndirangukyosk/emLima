...
<div style="display: inline-block;" class="qtybtns-addbtnd" id="add-btn-container">    
                <a style="display: <?= $product['qty_in_cart'] ? 'none' : 'block'; ?>" class="add-cart-btn btn-add btn-orange-addbtn" id="add-btn" data-variation-id="<?= $product['store_product_variation_id'] ?>" data-id="<?= $product['product_store_id'] ?>">
