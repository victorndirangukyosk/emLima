...
$('#button-quote').on('click', function() {
	$.ajax({
		url: 'index.php?path=checkout/shipping/quote',
		type: 'post',
...
$(document).delegate('#button-shipping', 'click', function() {
	$.ajax({
		url: 'index.php?path=checkout/shipping/shipping',
		type: 'post',
...
$('select[name=\'country_id\']').on('change', function() {
	$.ajax({
		url: 'index.php?path=checkout/shipping/country&country_id=' + this.value,
		dataType: 'json',
		beforeSend: function() {
