<?php if ($testmode) { ?>
<div style="margin: 30px 0 -15px;" class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> <?php echo $text_testmode; ?></div>
<?php } ?>
<form action="<?php echo $action; ?>" method="post">
  ...
  <input type="hidden" name="bn" value="Shop_2.0_WPS" />
  
  <div class="buttons">
    <div class="text-center">
        <button type="submit" onclick="if (!saveAddress()) { return false; }" id="button-confirm" class="btn-account-checkout btn-large btn-orange">CONFIRM ORDER</button>
    </div>
  </div>
