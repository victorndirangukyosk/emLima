                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xs-6 search-box-container searchbox-div">
                            ...
                            <div class="search-box">
                                <form onsubmit="location = '<?= $this->url->link('product/search') ?>&search=' + $('input[name=\'search\']').val(); return false;">
                                    <i class="fa fa-circle-o-notch fa-spin" style="display: none;"></i>
                                    <span></span>
                                    <input type="text" name="search" placeholder="Search for your product" />
