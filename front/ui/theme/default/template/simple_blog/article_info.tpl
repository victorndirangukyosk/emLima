                                            ...
                                            <div class="form-group">
                                                <div id="comments" class="blog-comment-info">
                                                    ...
                                                    <div class="comment-left">
                                                        ...
                                                        <input type="text" name="name" value="<?php if($this->customer->isLogged()){ 
                                                                                                     echo $this->customer->getFirstName().' '.$this->customer->getLastName();
...
<script type="text/javascript">
    ...
    $('#comment-list').load('index.php?path=blog/article/comment&simple_blog_article_id=<?php echo $simple_blog_article_id; ?>');
...
<script type="text/javascript">
    $('#button-comment').bind('click', function() {
        $.ajax({
            type: 'POST',
            url: 'index.php?path=blog/article/writeComment&simple_blog_article_id=<?php echo $simple_blog_article_id; ?>',
            dataType: 'json',
            ...
            beforeSend: function() {
                ...
                $('#review-title').after('<div class="attention"><img src="front/ui/theme/default/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
            },
            complete: function() {
