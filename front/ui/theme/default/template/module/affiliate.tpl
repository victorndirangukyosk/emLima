<div class="list-group">
  ...
  <?php } ?>
  <a href="<?php echo $payment; ?>" class="list-group-item"><?php echo $text_payment; ?></a> <a href="<?php echo $tracking; ?>" class="list-group-item"><?php echo $text_tracking; ?></a> <a href="<?php echo $commission; ?>" class="list-group-item"><?php echo $text_commission; ?></a>
  <?php if ($logged) { ?>
