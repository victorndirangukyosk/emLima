    ...
    <?php } ?>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" disabled="" value="<?php echo $quantity; ?>" placeholder="<?php echo $entry_quantity; ?>" id="input-quantity" class="form-control input-lg" />
            </div>
          </div>
          <div class="form-group required">
        ...
        <div class="buttons clearfix">
          <div class="pull-left col-md-4"><a href="<?php echo $back; ?>" class="btn btn-danger"><?php echo $button_back; ?></a></div>
        ...
        <?php } else { ?>
        <div class="buttons clearfix">
          <div class="pull-left col-md-4"><a href="<?php echo $back; ?>" class="btn btn-default"><?php echo $button_back; ?></a></div>
