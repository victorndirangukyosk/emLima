...
define('DB_PASSWORD', getenv('MYSQL_ROOT_PASSWORD') ? getenv('MYSQL_ROOT_PASSWORD') : 'goldtree9');
define('DB_DATABASE', getenv('MYSQL_ROOT_PASSWORD') ? basename(__DIR__) : 'emlima');
define('DB_PREFIX', 'hf7_');
