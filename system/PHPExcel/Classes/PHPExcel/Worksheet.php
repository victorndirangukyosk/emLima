...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    public function getCell($pCoordinate = 'A1')
    {
        ...
        if (false !== strpos($pCoordinate, ':') || false !== strpos($pCoordinate, ',')) {
            throw new PHPExcel_Exception('Cell coordinate can not be a range of cells.');
        } elseif (false !== strpos($pCoordinate, '$')) {
    ...
    public function freezePane($pCell = '')
    {
        ...
        if (false === strpos($pCell, ':') && false === strpos($pCell, ',')) {
    ...
    public function getComment($pCellCoordinate = 'A1')
    {
        ...
        if (false !== strpos($pCellCoordinate, ':') || false !== strpos($pCellCoordinate, ',')) {
            throw new PHPExcel_Exception('Cell coordinate string can not be a range of cells.');
        } elseif (false !== strpos($pCellCoordinate, '$')) {
...
//
     ...
     *
     * @param string|null Same rule as Title minus space not allowed (but, like Excel, change silently space to underscore)
     *
     * @return objWorksheet
     *
     * @throws PHPExcel_Exception
