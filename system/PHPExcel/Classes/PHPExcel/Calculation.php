...
class PHPExcel_Calculation
{
        ...
        if (in_array($language, self::$_validLocaleLanguages)) {
            ...
            if ('en_us' != $locale) {
                ...
                foreach ($localeFunctions as $localeFunction) {
                    ...
                    if (false !== strpos($localeFunction, '=')) {
    ...
    public function _calculateFormulaValue($formula, $cellID = null, PHPExcel_Cell $pCell = null)
    {
        ...
        if ((null !== $cellID) && ($this->getValueFromCache($wsTitle, $cellID, $cellValue))) {
            return $cellValue;
        }

        if (("\x00" !== $wsTitle[0]) && ($this->_cyclicReferenceStack->onStack($wsTitle.'!'.$cellID))) {
    ...
    {
        if (false === ($formula = self::_convertMatrixReferences(trim($formula)))) {
            return false;
        }
...
//					echo 'Element is a Variable, Constant, String, Number or Boolean<br />';
                    ...
                    if (':' == $testPrevOp['value']) {
                        ...
                        $rangeWS1 = '';
                        if (false !== strpos('!', $startRowColRef)) {
                    ...
                    if ('"' == $opCharacter) {
                        ...
                        if ((false !== strpos($val, '.')) || (false !== stripos($val, 'e')) || ($val > PHP_INT_MAX) || ($val < -PHP_INT_MAX)) {
                    ...
                    } elseif (false !== ($localeConstant = array_search(trim(strtoupper($val)), self::$_localeBoolean))) {
        ...
        foreach ($tokens as $tokenData) {
            ...
            if (isset(self::$_binaryOperators[$token])) {
                ...
                switch ($token) {
                    ...
                    case ':':			//	Range
                        $sheet1 = $sheet2 = '';
                        if (false !== strpos($operand1Data['reference'], '!')) {
                            list($sheet1, $operand1Data['reference']) = explode('!', $operand1Data['reference']);
                        } else {
                            $sheet1 = (null !== $pCellParent) ? $pCellWorksheet->getTitle() : '';
                        }
                        if (false !== strpos($operand2Data['reference'], '!')) {
                ...
                if (isset($matches[8])) {
                    ...
                    if (null === $pCell) {
                        ...
                        if ($matches[2] > '') {
                            ...
                            if ((false !== strpos($matches[2], '[')) || (false !== strpos($matches[2], ']'))) {
