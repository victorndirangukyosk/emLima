...
class PHPExcel_Reader_Excel2007 extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    private function _castToFormula($c, $r, &$cellDataType, &$value, &$calculatedValue, &$sharedFormulas, $castBaseType)
    {
        ...
        // Shared formula?
        if (isset($c->f['t']) && 'shared' == strtolower((string) $c->f['t'])) {
    ...
    //											echo 'Default', PHP_EOL;
                            ...
                            if ($xmlWorkbook->definedNames) {
                                foreach ($xmlWorkbook->definedNames->definedName as $definedName) {
                                    ...
                                    if (false !== ($spos = strpos($extractedRange, '!'))) {
                                    ...
                                    // Valid range?
                                    if (false !== stripos((string) $definedName, '#REF!') || '' == $extractedRange) {
                                        continue;
                                    }
                        ...
                        if ($xmlWorkbook->definedNames) {
                            foreach ($xmlWorkbook->definedNames->definedName as $definedName) {
                                ...
                                if ('' != (string) $definedName['localSheetId']) {
                                    ...
                                    $locatedSheet = null;
                                    $extractedSheetName = '';
                                    if (false !== strpos((string) $definedName, '!')) {
                                        // Extract sheet name
