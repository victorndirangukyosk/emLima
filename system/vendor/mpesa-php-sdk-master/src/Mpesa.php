...
/*define('consumer_key', '2PAluPpifGG2L8IHrGMTk726qQRqhoeI');
define('consumer_secret', 'WiGg0Wci3yVpir06');
define('status', 'sandbox');
define('live', 'false');*/
...
class Mpesa 
{
    ...
    public function __construct($mpesa_customer_key,$mpesa_customer_secret,$mpesa_environment = 'sandbox',$live = false) {
        define('consumer_key', $mpesa_customer_key);
        define('consumer_secret', $mpesa_customer_secret);
        define('status', $mpesa_environment);
        define('live', $live);
    }
    ...
    public static function generateLiveToken() {
        ...
        /*echo "<pre>";print_r($consumer_key);
        echo "<pre>";print_r($consumer_secret);*/
        ...
        echo "<pre>";print_r($response->access_token);
    ...
    public static function b2c($InitiatorName, $SecurityCredential, $CommandID, $Amount, $PartyA, $PartyB, $Remarks, $QueueTimeOutURL, $ResultURL, $Occasion){
        //$live='sandbox';//env("application_status");
        $live=status;
