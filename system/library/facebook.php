...
class Facebook extends BaseFacebook
{
     ...
     * Cookie prefix.
     */
    const FBSS_COOKIE_NAME = 'cudemy_catalog';
     ...
     * @var string
     */
    protected $sharedSessionID = 'cudemy_catalog';
    ...
    public function __construct($config)
    {
      ...
      && PHP_SESSION_ACTIVE !== session_status()) || !session_id()) {
            session_start();
        }
